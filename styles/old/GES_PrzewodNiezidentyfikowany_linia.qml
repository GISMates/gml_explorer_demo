...
<qgis version="3.22.4-Białowieża" styleCategories="Symbology|Labeling|Actions" labelsEnabled="1">
  <renderer-v2 referencescale="-1" enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{6189860c-f783-4145-a5f9-c7fbe370881b}">
      <rule scalemindenom="1" symbol="0" filter="IF (@map_scale &lt;= 500, coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy' AND (&quot;srednica&quot; IS NULL OR &quot;srednica&quot;/1000 &lt;= 0.75), coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy')" scalemaxdenom="1001" key="{17b0aab9-96d7-4a56-8020-c9ebc7055cad}" label="przewód niezidentyfikowany SUPZ_01"/>
      <rule scalemindenom="1" symbol="1" filter=" coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy' AND &quot;srednica&quot; IS NOT NULL AND &quot;srednica&quot;/1000 > 0.75" scalemaxdenom="501" key="{4ac38f4e-64a1-49d1-a0f2-91523b56b2e9}" label="przewód niezidentyfikowany SUPZ_02"/>
      <rule scalemindenom="1" symbol="2" filter="IF (@map_scale &lt;= 500, coalesce(&quot;istnienie&quot;, 'istniejacy') IN ('projektowany', 'wBudowie') AND (&quot;srednica&quot; IS NULL OR &quot;srednica&quot;/1000 &lt;= 0.75), coalesce(&quot;istnienie&quot;, 'istniejacy') IN ('projektowany', 'wBudowie'))" scalemaxdenom="1001" key="{9f838146-e704-4206-aed5-c16033ac42c5}" label="przewód niezidentyfikowany - projektowany lub w budowie SUPZ_P_01"/>
      <rule scalemindenom="1" symbol="3" filter=" coalesce(&quot;istnienie&quot;, 'istniejacy') IN ('projektowany', 'wBudowie') AND &quot;srednica&quot; IS NOT NULL AND &quot;srednica&quot;/1000 > 0.75" scalemaxdenom="501" key="{665618df-0093-4d15-89e0-f39559bc90ff}" label="przewód niezidentyfikowany - projektowany lub w budowie SUPZ_P_02"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{c20de114-bb27-4f37-84a4-51b8a63645ce}">
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{f1a0361a-686d-40e9-969c-918267e3a12a}">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{2408d200-c36d-43ea-a2e2-6b269a66c96a}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{2486094a-efe4-437f-956f-cb6b26c3eb5e}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{dab4c695-7ffe-45c1-8e00-f5185372e260}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{c479909b-37d7-42ed-99bd-d3d5df6cc73c}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{c8d21f07-5435-4dc6-b18b-a510942b801c}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{ebe2d641-8751-4841-8413-2791fb822e2b}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{1edd5a3c-8452-4a98-a35f-8ed6b9708ca3}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{ccfc7ca0-dc2f-4815-be17-c968f50199c4}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{ea83d496-0628-45a8-95b0-1a5552635e0c}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{9bf64103-4b6b-4f37-b6b8-66bf1e6b86c7}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{bde9a43d-5c3b-4cc7-99d7-6298e3f50776}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{ad1ea308-648e-4a5c-a82e-054cd6545363}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{65ff6af4-d364-46ab-81a4-bf5be01fdfe5}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{b7711bae-baf7-45f6-a320-ea0f3779c732}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{87dda26e-1040-43ae-8443-5f9be38530e7}">
        <settings calloutType="simple">
