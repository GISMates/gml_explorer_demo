...
<qgis version="3.22.4-Białowieża" styleCategories="Symbology|Labeling|Actions" labelsEnabled="1">
  <renderer-v2 referencescale="-1" enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{e11996b4-d114-44b0-bb62-8149c1e3a3fc}">
      <rule scalemindenom="1" symbol="0" filter="IF( @map_scale &lt;= 500, (&quot;liczbaPrzewodow&quot; IS NULL OR &quot;liczbaPrzewodow&quot; &lt;= 10) AND (&quot;przebieg&quot; IS NULL OR &quot;przebieg&quot; IN('naziemny', 'podziemny')) AND coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy', (&quot;przebieg&quot; IS NULL OR &quot;przebieg&quot; IN('naziemny', 'podziemny')) AND coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy')" scalemaxdenom="1001" key="{fa009073-4879-407a-9938-2aacc416e4ca}" label="przewód telekomunikacyjny SUPT_01"/>
      <rule scalemindenom="1" symbol="1" filter="&quot;liczbaPrzewodow&quot; > 10 AND coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy'" scalemaxdenom="501" key="{dd5a623d-e989-47ac-8c0f-f393f62b8047}" label="przewód telekomunikacyjny SUPT_02"/>
      <rule scalemindenom="1" symbol="2" filter="&quot;przebieg&quot; = 'nadziemny' AND coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy'" scalemaxdenom="2001" key="{081c8467-0214-4063-a783-1a281cc8ae21}" label="przewód telekomunikacyjny SUPT01"/>
      <rule scalemindenom="1" symbol="3" filter="IF (@map_scale &lt;= 500, (&quot;liczbaPrzewodow&quot; IS NULL OR &quot;liczbaPrzewodow&quot; &lt;= 10) AND coalesce(&quot;istnienie&quot;, 'istniejacy') IN('projektowany', 'wBudowie'), coalesce(&quot;istnienie&quot;, 'istniejacy') IN('projektowany', 'wBudowie'))" scalemaxdenom="1001" key="{0730e234-4b00-46f3-9d3e-d013264267c4}" label="przewód telekomunikacyjny - projektowany lub w budowie SUPT_P_01"/>
      <rule scalemindenom="1" symbol="4" filter="&quot;liczbaPrzewodow&quot; > 10 AND coalesce(&quot;istnienie&quot;, 'istniejacy') IN('projektowany', 'wBudowie')" scalemaxdenom="501" key="{6d30417e-19d1-483d-a3d5-ae0ebfc2d585}" label="przewód telekomunikacyjny - projektowany lub w budowie SUPT_P_02"/>
    </rules>
    <symbols>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="offset" type="Map">
                  <Option name="active" value="true" type="bool"/>
                  <Option name="expression" value="750 / (2 * @map_scale)" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
              </Option>
              <Option name="type" value="collection" type="QString"/>
      ...
      <symbol alpha="1" name="2" force_rhr="0" clip_to_extent="0" type="line">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer locked="0" enabled="1" pass="0" class="MarkerLine">
          ...
          <symbol alpha="1" name="@2@0" force_rhr="0" clip_to_extent="1" type="marker">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
            ...
            <layer locked="0" enabled="1" pass="0" class="SvgMarker">
              <Option type="Map">
                ...
                <Option name="name" value="C:/Users/wizipisi/AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins/gml_explorer_dev/symbols/SUPT01_przewod telekomunikacyjny.svg" type="QString"/>
              ...
              <prop v="C:/Users/wizipisi/AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins/gml_explorer_dev/symbols/SUPT01_przewod telekomunikacyjny.svg" k="name"/>
              <prop v="0,0" k="offset"/>
              <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
                ...
                <Option type="Map">
                  ...
                  <Option name="properties" type="Map">
                    <Option name="angle" type="Map">
                      <Option name="active" value="true" type="bool"/>
                      <Option name="expression" value="IF( @geometry_point_num > 1, azimuth( point_n( $geometry,  @geometry_point_num ), point_n( $geometry,  @geometry_point_num - 1)) * 180 / pi(), null)" type="QString"/>
                      <Option name="type" value="3" type="int"/>
                    </Option>
                    <Option name="offset" type="Map">
                      <Option name="active" value="true" type="bool"/>
                      <Option name="expression" value="IF( @map_scale &lt;= 500, '0,-2.3', IF( @map_scale > 500 AND @map_scale &lt;= 1000, '0,-3.5', '0,-4.9'))" type="QString"/>
                      <Option name="type" value="3" type="int"/>
                    </Option>
                    <Option name="width" type="Map">
                      <Option name="active" value="true" type="bool"/>
                      <Option name="expression" value="IF( @geometry_point_num = 1, 0, IF( @map_scale &lt;= 500, 1, IF( @map_scale > 500 AND @map_scale &lt;= 1000, 1.4, IF(@map_scale > 1000 AND @map_scale &lt;= 2000, 2, 5))))" type="QString"/>
                      <Option name="type" value="3" type="int"/>
                    </Option>
                  </Option>
                  <Option name="type" value="collection" type="QString"/>
              ...
              <data_defined_properties>
                <Option type="Map">
                  ...
                  <Option name="properties" type="Map">
                    <Option name="angle" type="Map">
                      <Option name="active" value="true" type="bool"/>
                      <Option name="expression" value="azimuth( point_n( $geometry,  @geometry_point_num ), point_n( $geometry,  @geometry_point_num + 1)) * 180 / pi()" type="QString"/>
                      <Option name="type" value="3" type="int"/>
                    </Option>
                    <Option name="offset" type="Map">
                      <Option name="active" value="true" type="bool"/>
                    ...
                    <Option name="width" type="Map">
                      <Option name="active" value="true" type="bool"/>
                      <Option name="expression" value="IF( @geometry_point_num = num_points($geometry), 0, IF( @map_scale &lt;= 500, 1, IF( @map_scale > 500 AND @map_scale &lt;= 1000, 1.4, IF(@map_scale > 1000 AND @map_scale &lt;= 2000, 2, 5))))" type="QString"/>
                      <Option name="type" value="3" type="int"/>
                    </Option>
                  </Option>
                  <Option name="type" value="collection" type="QString"/>
  ...
  <labeling type="rule-based">
    <rules key="{f042baac-f0a1-4d49-8dc4-e60a8ff53e67}">
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{abaaa712-28d9-4df0-b00d-b013494e27d9}">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{292f7423-c3a1-46c5-bc74-74385f77cdd8}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{58ddf7a5-c665-4880-a527-fde3bda8b000}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{56454ce3-1ca0-462e-b7b0-2ac921d5bd0a}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{bb1cd784-1a63-4685-89e9-c0eed4b6fa48}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{cb1a8828-e85c-4fef-99b8-9312aa3ad141}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{29916d34-c6f8-40cf-b039-636458907461}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{4dde238b-4e74-4e18-8b8e-a19b457c3411}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{95626499-725a-46a9-a32a-a972fb620c62}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{945f6784-457b-45d5-8d47-c49331f84ede}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{bcc60878-ce62-4b53-897e-a46aa8b30ff8}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{a3052701-9db1-4ba8-8a1f-fcbaa4dd922a}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{10e5eda9-a9a9-40fa-91e2-f995b718d83d}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{2f85d01d-2f5c-4dcd-9605-e73c386024e7}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{05b32752-dd1c-42d1-99b6-4fe9a61a6ebc}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{a9502be9-7709-487d-855a-cb896337c4c7}">
        <settings calloutType="simple">
