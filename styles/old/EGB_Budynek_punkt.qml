...
<qgis version="3.22.4-Białowieża" styleCategories="Symbology|Labeling|Actions" labelsEnabled="1">
  <renderer-v2 referencescale="-1" enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{67c0d451-b7ae-4ab7-9933-9705989f7484}">
      <rule symbol="0" filter="&quot;statusBudynku&quot; IN (1, 3)" key="{170136b5-3855-4fd7-8990-ac868365c894}" label="budynek EGBB01_02"/>
      <rule symbol="1" filter="&quot;statusBudynku&quot; = 4" key="{35824dca-8b92-4651-83bb-3c1e557a6d1c}" label="budynek projektowany EGBB02_01"/>
    </rules>
    <symbols>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="size" type="Map">
                  ...
                  <Option name="expression" value="IF(@map_scale &lt;= 500, 1, IF(@map_scale > 500 AND @map_scale &lt;= 1000, 1.5, IF(@map_scale > 1000 AND @map_scale &lt;= 2000, 3, 5)))" type="QString"/>
  ...
  <labeling type="rule-based">
    <rules key="{09b38d9a-4834-4d2d-a4ac-5d0805694466}">
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{db6723e6-e8ba-4c50-a361-bf1b5816480b}">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{afc152f3-be78-40d8-acc8-da25e2ebf5f0}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{b8883304-32ea-4dc1-a5a7-a6bd0e40358b}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{d22038c9-b033-4400-b01e-2aa20f721e30}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{131f9b09-841f-4eaf-b69b-7306e91173d6}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{fd3e2d80-4269-4727-b016-816b06248918}">
        <settings calloutType="simple">
