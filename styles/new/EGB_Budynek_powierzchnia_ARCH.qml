...
<qgis version="3.22.12-Białowieża" styleCategories="Symbology|Labeling|Actions" labelsEnabled="1">
  <renderer-v2 referencescale="-1" symbollevels="0" forceraster="0" type="RuleRenderer" enableorderby="0">
    <rules key="{5a71896f-dbb8-4a5c-95c6-b2ed99ce03fa}">
      <rule label="budynek naziemny EGBU" filter="&quot;liczbaKondygnacjiNadziemnych&quot; > 0 OR (&quot;liczbaKondygnacjiNadziemnych&quot; IS NULL AND (&quot;liczbaKondygnacjiPodziemnych&quot; = 0 OR &quot;liczbaKondygnacjiPodziemnych&quot; IS NULL))" symbol="0" key="{63f3a076-15f8-472c-9072-e09bd67ff6f5}"/>
      <rule label="budynek podziemny EGBU-p" filter="&quot;liczbaKondygnacjiPodziemnych&quot; > 0 AND (&quot;liczbaKondygnacjiNadziemnych&quot; = 0 OR &quot;liczbaKondygnacjiNadziemnych&quot; IS NULL)" symbol="1" key="{7275aa22-c987-456d-b40b-fb1a7ee63ede}"/>
    </rules>
    <symbols>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="outlineWidth" type="Map">
                  ...
                  <Option name="expression" value="IF( @map_scale &lt;= 500, 0.25, IF(@map_scale &lt;= 1000, 0.35, IF(@map_scale &lt;= 2000, 0.7, 1.75)))" type="QString"/>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="customDash" type="Map">
                  <Option name="active" value="true" type="bool"/>
                  <Option name="expression" value="IF(@map_scale &lt;= 500, '1;0.5', IF(@map_scale &lt;= 1000, '2;1', IF(@map_scale &lt;= 2000, '4;2', '10;5')))" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
                <Option name="outlineWidth" type="Map">
                  <Option name="active" value="true" type="bool"/>
  ...
  <labeling type="rule-based">
    <rules key="{52cce0e2-a8c4-4415-8103-d1e16bb77610}">
      <rule filter=" IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True), True), True)" description="Prezentacja graficzna" key="{5b0c8de6-2800-4f5b-a31c-efd4c3753e60}" scalemaxdenom="1001" scalemindenom="1">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" isExpression="1" textOpacity="1" blendMode="0" multilineHeight="1" capitalization="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Normal" fontSizeUnit="RenderMetersInMapUnits" fontStrikeout="0" textColor="125,125,125,255" legendString="Aa" fontWeight="50" textOrientation="horizontal" fontUnderline="0" fontWordSpacing="0" fontFamily="Arial" fontLetterSpacing="0" fieldName="IF(&quot;liczbaKondygnacjiNadziemnych&quot; > 0 OR (&quot;liczbaKondygnacjiNadziemnych&quot; IS NULL AND (&quot;liczbaKondygnacjiPodziemnych&quot; = 0 OR &quot;liczbaKondygnacjiPodziemnych&quot; IS NULL)), concat(&quot;rodzajWgKST&quot;,  &quot;liczbaKondygnacjiNadziemnych&quot;), IF(&quot;liczbaKondygnacjiPodziemnych&quot; > 0 AND (&quot;liczbaKondygnacjiNadziemnych&quot; = 0 OR &quot;liczbaKondygnacjiNadziemnych&quot; IS NULL), concat(&quot;rodzajWgKST&quot;, '-',  &quot;liczbaKondygnacjiPodziemnych&quot;), ''))" fontSize="1" allowHtml="0" useSubstitutions="0" fontKerning="1" fontItalic="0">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0" bufferSize="0" bufferJoinStyle="128" bufferOpacity="1" bufferDraw="1" bufferColor="255,255,255,255" bufferNoFill="1" bufferSizeUnits="RenderMetersInMapUnits"/>
          ...
          <placement offsetType="0" centroidWhole="0" polygonPlacementFlags="2" distMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" geometryGeneratorType="PointGeometry" priority="5" repeatDistanceUnits="MM" lineAnchorClipping="0" rotationAngle="0" centroidInside="0" geometryGenerator=" IF(&quot;PrezentacjaGraficzna_geometria&quot;, geom_from_wkt(string_to_array( &quot;PrezentacjaGraficzna_geometria&quot; , ', ')[0]), centroid($geometry))" maxCurvedCharAngleOut="-25" dist="0" repeatDistance="0" overrunDistance="0" offsetUnits="MM" placementFlags="10" overrunDistanceUnit="MM" lineAnchorType="0" preserveRotation="1" geometryGeneratorEnabled="1" distUnits="MM" fitInPolygonOnly="0" placement="1" xOffset="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" quadOffset="4" lineAnchorPercent="0.5" yOffset="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" layerType="PolygonGeometry" rotationUnit="AngleRadians" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0"/>
      ...
      <rule filter=" IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True), True), True)" description="Prezentacja graficzna" key="{d7c46d41-8ff6-4c60-bf62-2d40fa535eef}" scalemaxdenom="1001" scalemindenom="1">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" isExpression="1" textOpacity="1" blendMode="0" multilineHeight="1" capitalization="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Normal" fontSizeUnit="RenderMetersInMapUnits" fontStrikeout="0" textColor="125,125,125,255" legendString="Aa" fontWeight="50" textOrientation="horizontal" fontUnderline="0" fontWordSpacing="0" fontFamily="Arial" fontLetterSpacing="0" fieldName="IF(&quot;liczbaKondygnacjiNadziemnych&quot; > 0 OR (&quot;liczbaKondygnacjiNadziemnych&quot; IS NULL AND (&quot;liczbaKondygnacjiPodziemnych&quot; = 0 OR &quot;liczbaKondygnacjiPodziemnych&quot; IS NULL)), concat(&quot;rodzajWgKST&quot;,  &quot;liczbaKondygnacjiNadziemnych&quot;), IF(&quot;liczbaKondygnacjiPodziemnych&quot; > 0 AND (&quot;liczbaKondygnacjiNadziemnych&quot; = 0 OR &quot;liczbaKondygnacjiNadziemnych&quot; IS NULL), concat(&quot;rodzajWgKST&quot;, '-',  &quot;liczbaKondygnacjiPodziemnych&quot;), ''))" fontSize="1" allowHtml="0" useSubstitutions="0" fontKerning="1" fontItalic="0">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0" bufferSize="0" bufferJoinStyle="128" bufferOpacity="1" bufferDraw="1" bufferColor="255,255,255,255" bufferNoFill="1" bufferSizeUnits="RenderMetersInMapUnits"/>
      ...
      <rule filter=" IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True), True), True)" description="Prezentacja graficzna" key="{add7cd3c-4535-4c6a-aa44-c1eb7999bccb}" scalemaxdenom="1001" scalemindenom="1">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" isExpression="1" textOpacity="1" blendMode="0" multilineHeight="1" capitalization="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Normal" fontSizeUnit="RenderMetersInMapUnits" fontStrikeout="0" textColor="125,125,125,255" legendString="Aa" fontWeight="50" textOrientation="horizontal" fontUnderline="0" fontWordSpacing="0" fontFamily="Arial" fontLetterSpacing="0" fieldName="IF(&quot;liczbaKondygnacjiNadziemnych&quot; > 0 OR (&quot;liczbaKondygnacjiNadziemnych&quot; IS NULL AND (&quot;liczbaKondygnacjiPodziemnych&quot; = 0 OR &quot;liczbaKondygnacjiPodziemnych&quot; IS NULL)), concat(&quot;rodzajWgKST&quot;,  &quot;liczbaKondygnacjiNadziemnych&quot;), IF(&quot;liczbaKondygnacjiPodziemnych&quot; > 0 AND (&quot;liczbaKondygnacjiNadziemnych&quot; = 0 OR &quot;liczbaKondygnacjiNadziemnych&quot; IS NULL), concat(&quot;rodzajWgKST&quot;, '-',  &quot;liczbaKondygnacjiPodziemnych&quot;), ''))" fontSize="1" allowHtml="0" useSubstitutions="0" fontKerning="1" fontItalic="0">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0" bufferSize="0" bufferJoinStyle="128" bufferOpacity="1" bufferDraw="1" bufferColor="255,255,255,255" bufferNoFill="1" bufferSizeUnits="RenderMetersInMapUnits"/>
      ...
      <rule filter=" IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True), True), True)" description="Prezentacja graficzna" key="{8f6fd334-78c4-4542-8d31-85ac4cdd612f}" scalemaxdenom="1001" scalemindenom="1">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" isExpression="1" textOpacity="1" blendMode="0" multilineHeight="1" capitalization="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Normal" fontSizeUnit="RenderMetersInMapUnits" fontStrikeout="0" textColor="125,125,125,255" legendString="Aa" fontWeight="50" textOrientation="horizontal" fontUnderline="0" fontWordSpacing="0" fontFamily="Arial" fontLetterSpacing="0" fieldName="IF(&quot;liczbaKondygnacjiNadziemnych&quot; > 0 OR (&quot;liczbaKondygnacjiNadziemnych&quot; IS NULL AND (&quot;liczbaKondygnacjiPodziemnych&quot; = 0 OR &quot;liczbaKondygnacjiPodziemnych&quot; IS NULL)), concat(&quot;rodzajWgKST&quot;,  &quot;liczbaKondygnacjiNadziemnych&quot;), IF(&quot;liczbaKondygnacjiPodziemnych&quot; > 0 AND (&quot;liczbaKondygnacjiNadziemnych&quot; = 0 OR &quot;liczbaKondygnacjiNadziemnych&quot; IS NULL), concat(&quot;rodzajWgKST&quot;, '-',  &quot;liczbaKondygnacjiPodziemnych&quot;), ''))" fontSize="1" allowHtml="0" useSubstitutions="0" fontKerning="1" fontItalic="0">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0" bufferSize="0" bufferJoinStyle="128" bufferOpacity="1" bufferDraw="1" bufferColor="255,255,255,255" bufferNoFill="1" bufferSizeUnits="RenderMetersInMapUnits"/>
      ...
      <rule filter=" IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True), True), True)" description="Prezentacja graficzna" key="{72f4dac1-a151-4e3d-b966-550ac5c6145c}" scalemaxdenom="1001" scalemindenom="1">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" isExpression="1" textOpacity="1" blendMode="0" multilineHeight="1" capitalization="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Normal" fontSizeUnit="RenderMetersInMapUnits" fontStrikeout="0" textColor="125,125,125,255" legendString="Aa" fontWeight="50" textOrientation="horizontal" fontUnderline="0" fontWordSpacing="0" fontFamily="Arial" fontLetterSpacing="0" fieldName="IF(&quot;liczbaKondygnacjiNadziemnych&quot; > 0 OR (&quot;liczbaKondygnacjiNadziemnych&quot; IS NULL AND (&quot;liczbaKondygnacjiPodziemnych&quot; = 0 OR &quot;liczbaKondygnacjiPodziemnych&quot; IS NULL)), concat(&quot;rodzajWgKST&quot;,  &quot;liczbaKondygnacjiNadziemnych&quot;), IF(&quot;liczbaKondygnacjiPodziemnych&quot; > 0 AND (&quot;liczbaKondygnacjiNadziemnych&quot; = 0 OR &quot;liczbaKondygnacjiNadziemnych&quot; IS NULL), concat(&quot;rodzajWgKST&quot;, '-',  &quot;liczbaKondygnacjiPodziemnych&quot;), ''))" fontSize="1" allowHtml="0" useSubstitutions="0" fontKerning="1" fontItalic="0">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0" bufferSize="0" bufferJoinStyle="128" bufferOpacity="1" bufferDraw="1" bufferColor="255,255,255,255" bufferNoFill="1" bufferSizeUnits="RenderMetersInMapUnits"/>
