...
<qgis version="3.22.4-Białowieża" styleCategories="Symbology|Labeling|Actions" labelsEnabled="1">
  <renderer-v2 referencescale="-1" enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{42085a9a-a016-41ac-ba52-cb6612b26008}">
      <rule symbol="0" filter=" &quot;kodStabilizacji&quot; IN(3, 4, 5)" key="{a4b5d650-3c6b-40d1-a6d8-b5ea6cfc8077}" label="stabilizowany trwale EGBP04_02, EGBP04_2a"/>
      <rule symbol="1" filter=" &quot;kodStabilizacji&quot; IN(1, 2)" key="{ad57b04b-2646-4bab-a613-caafd7078730}" label="niestabilizowany EGBP04_03, EGBP04_3a"/>
    </rules>
    <symbols>
      <symbol alpha="1" name="0" force_rhr="0" clip_to_extent="1" type="marker">
        ...
        <layer locked="0" enabled="1" pass="0" class="GeometryGenerator">
          <Option type="Map">
            ...
            <Option name="geometryModifier" value=" geom_from_wkt(  &quot;KR_ObiektKarto_odnosnik&quot; )" type="QString"/>
            <Option name="units" value="MapUnit" type="QString"/>
          </Option>
          <prop v="Line" k="SymbolType"/>
          <prop v=" geom_from_wkt(  &quot;KR_ObiektKarto_odnosnik&quot; )" k="geometryModifier"/>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                ...
                <Option name="size" type="Map">
                  <Option name="active" value="true" type="bool"/>
                  <Option name="expression" value="(IF( @map_scale &lt;= 500, 0.5, IF( @map_scale > 500 AND  @map_scale &lt;= 1000, 0.8, IF(@map_scale > 1000 AND @map_scale &lt;= 2000, 1.6, 3))))" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
              </Option>
              <Option name="type" value="collection" type="QString"/>
      ...
      <symbol alpha="1" name="1" force_rhr="0" clip_to_extent="1" type="marker">
        ...
        <layer locked="0" enabled="1" pass="0" class="SimpleMarker">
          ...
          <effect enabled="0" type="effectStack">
            ...
            <effect type="color">
              <Option type="Map">
                <Option name="blend_mode" value="22" type="QString"/>
                <Option name="brightness" value="255" type="QString"/>
                <Option name="colorize" value="0" type="QString"/>
                <Option name="colorize_color" value="255,128,128,255" type="QString"/>
                <Option name="colorize_strength" value="100" type="QString"/>
                <Option name="contrast" value="0" type="QString"/>
                <Option name="draw_mode" value="2" type="QString"/>
                <Option name="enabled" value="1" type="QString"/>
                <Option name="grayscale_mode" value="0" type="QString"/>
                <Option name="opacity" value="1" type="QString"/>
                <Option name="saturation" value="1" type="QString"/>
              </Option>
              <prop v="22" k="blend_mode"/>
              <prop v="255" k="brightness"/>
              <prop v="0" k="colorize"/>
              <prop v="255,128,128,255" k="colorize_color"/>
              <prop v="100" k="colorize_strength"/>
              <prop v="0" k="contrast"/>
              <prop v="2" k="draw_mode"/>
              <prop v="1" k="enabled"/>
              <prop v="0" k="grayscale_mode"/>
              <prop v="1" k="opacity"/>
              <prop v="1" k="saturation"/>
            </effect>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="size" type="Map">
                  <Option name="active" value="true" type="bool"/>
                  <Option name="expression" value="IF(@map_scale &lt;= 500, 0.09, IF(@map_scale > 500 AND @map_scale &lt;= 1000, 0.18, IF(@map_scale > 1000 AND @map_scale &lt;= 2000, 0.36, 0.9)))" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
              </Option>
              <Option name="type" value="collection" type="QString"/>
        ...
        <layer locked="0" enabled="1" pass="0" class="GeometryGenerator">
          ...
          <symbol alpha="1" name="@1@1" force_rhr="0" clip_to_extent="1" type="line">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{5fdabacd-531e-41e6-b2e4-12d123f455f8}">
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{ac17ab49-1b4e-43af-a07a-a69ec7f288dc}">
          ...
          <dd_properties>
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                ...
                <Option name="Size" type="Map">
                  <Option name="active" value="true" type="bool"/>
                  <Option name="expression" value="IF(@map_scale&lt;=500, 0.75, IF(@map_scale > 500 AND @map_scale &lt;= 1000, 1.5, IF(@map_scale > 1000 AND @map_scale &lt;= 2000, 3, 7.5)))" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
