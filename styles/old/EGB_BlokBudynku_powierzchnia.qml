...
<qgis version="3.22.4-Białowieża" styleCategories="Symbology|Labeling|Actions" labelsEnabled="1">
  <renderer-v2 referencescale="-1" enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{d8e976bf-b501-4774-a555-f286f2b8723f}">
      <rule scalemindenom="1" symbol="0" filter=" &quot;rodzajBloku&quot; = 1" scalemaxdenom="2001" key="{ffbae7eb-c3d3-4c15-87e0-6df9337019a2}" label="kondygnacje nadziemne EGBC03"/>
      <rule symbol="1" filter=" &quot;rodzajBloku&quot; = 2" key="{8ce3b23d-5922-434c-8f91-fb4bda487791}" label="kondygnacje podziemne EGBC04"/>
      <rule scalemindenom="1" symbol="2" filter=" &quot;rodzajBloku&quot; = 3 AND (&quot;numerNajnizszejKondygnacji&quot; >= 0 OR  &quot;numerNajwyzszejKondygnacji&quot; >= 0)" scalemaxdenom="2001" key="{284a1a15-02f2-4fab-b363-9d571629733c}" label="łącznik nadziemny EGBL05"/>
      <rule scalemindenom="1" symbol="3" filter=" &quot;rodzajBloku&quot; = 3 AND (&quot;numerNajnizszejKondygnacji&quot; &lt; 0 AND  &quot;numerNajwyzszejKondygnacji&quot; &lt; 0)" scalemaxdenom="2001" key="{53c13dd7-3ffa-43b4-a072-520ae25ad81a}" label="łącznik podziemny EGBL05_01"/>
      <rule scalemindenom="1" symbol="4" filter="&quot;rodzajBloku&quot; = 4" scalemaxdenom="2001" key="{7626ae47-63c4-4ddf-8e7f-9b730d0ad742}" label="nawis EGBN11"/>
      <rule scalemindenom="1" symbol="5" filter="&quot;rodzajBloku&quot; = 5" scalemaxdenom="1001" key="{c8a684a1-ddca-4da0-a700-8fa0153f74c1}" label="przejazd przez budynek EGBP16"/>
      <rule scalemindenom="1" symbol="6" filter="&quot;rodzajBloku&quot; = 6" scalemaxdenom="1001" key="{eb53449d-0ae1-4b2f-a2da-166e4c81c70d}" label="inny"/>
    </rules>
    <symbols>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="customDash" type="Map">
                  <Option name="active" value="true" type="bool"/>
                  <Option name="expression" value="IF( @map_scale &lt;= 500, '1;0.5', IF(@map_scale > 500 AND @map_scale &lt;= 1000, '1.4;0.7', IF(@map_scale > 1000 AND @map_scale &lt;= 2000, '2.8;1.4', '7;3.5')))" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
                <Option name="outlineWidth" type="Map">
                  <Option name="active" value="true" type="bool"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="customDash" type="Map">
                  <Option name="active" value="true" type="bool"/>
                  <Option name="expression" value="IF( @map_scale &lt;= 500, '1;0.5', IF(@map_scale > 500 AND @map_scale &lt;= 1000, '1.4;0.7', '2.8;1.4'))" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
                <Option name="outlineWidth" type="Map">
                  <Option name="active" value="true" type="bool"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="customDash" type="Map">
                  <Option name="active" value="true" type="bool"/>
                  <Option name="expression" value="IF( @map_scale &lt;= 500, '2;0.5', IF(@map_scale > 500 AND @map_scale &lt;= 1000, '3;0.7', '6;1.4'))" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
                <Option name="outlineWidth" type="Map">
                  <Option name="active" value="true" type="bool"/>
                  <Option name="expression" value="IF( @map_scale &lt;= 500, 0.25, IF( @map_scale > 500 AND  @map_scale &lt;= 1000, 0.35, 0.5))" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
              </Option>
              <Option name="type" value="collection" type="QString"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="customDash" type="Map">
                  <Option name="active" value="true" type="bool"/>
                  <Option name="expression" value="IF( @map_scale &lt;= 500, '1;0.5', '1.5;0.7')" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
                <Option name="outlineWidth" type="Map">
                  <Option name="active" value="true" type="bool"/>
  ...
  <labeling type="rule-based">
    <rules key="{b9f4a8db-a72d-4284-b28f-028823a946a7}">
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{c984c6ab-fae4-4ef3-b115-4073bd600790}">
        <settings calloutType="simple">
          <text-style fontSizeUnit="RenderMetersInMapUnits" fieldName="IF(string_to_array(&quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[0] IS NULL, IF( &quot;rodzajBloku&quot; = 1, &quot;numerNajwyzszejKondygnacji&quot;, IF( &quot;rodzajBloku&quot; = 2, IF(&quot;numerNajnizszejKondygnacji&quot; is not null, concat('-', to_string(&quot;numerNajnizszejKondygnacji&quot;)), ''), IF( &quot;rodzajBloku&quot; = 3 AND (&quot;numerNajnizszejKondygnacji&quot; >= 0 OR &quot;numerNajwyzszejKondygnacji&quot; >= 0), IF(&quot;numerNajwyzszejKondygnacji&quot; IS NOT NULL AND  &quot;numerNajnizszejKondygnacji&quot; IS NOT NULL, concat( &quot;numerNajnizszejKondygnacji&quot; , '/',  &quot;numerNajwyzszejKondygnacji&quot; ), ''), IF( &quot;rodzajBloku&quot; = 3 AND (&quot;numerNajnizszejKondygnacji&quot; &lt; 0 AND  &quot;numerNajwyzszejKondygnacji&quot; &lt; 0), IF(&quot;numerNajwyzszejKondygnacji&quot; IS NOT NULL AND  &quot;numerNajnizszejKondygnacji&quot; IS NOT NULL, concat('-', &quot;numerNajnizszejKondygnacji&quot; , '/-',  &quot;numerNajwyzszejKondygnacji&quot; ), ''), IF( &quot;rodzajBloku&quot; = 5, IF(&quot;numerNajwyzszejKondygnacji&quot; IS NOT NULL AND  &quot;numerNajnizszejKondygnacji&quot; IS NOT NULL, concat( &quot;numerNajnizszejKondygnacji&quot; , '/',  &quot;numerNajwyzszejKondygnacji&quot; ), ''), ''))))), string_to_array(&quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[0])" textColor="10,9,9,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" legendString="Aa" isExpression="1" multilineHeight="1" fontUnderline="0" fontWeight="50" fontKerning="1" textOpacity="1" previewBkgrdColor="255,255,255,255" fontStrikeout="0" fontLetterSpacing="0" textOrientation="horizontal" fontWordSpacing="0" fontFamily="Arial" blendMode="0" namedStyle="Normal" allowHtml="0" capitalization="0" fontItalic="0" fontSize="1.25">
            <families/>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                ...
                <Option name="Size" type="Map">
                  <Option name="active" value="true" type="bool"/>
                  <Option name="expression" value="IF(@map_scale&lt;=500, 1.25, IF(@map_scale > 500 AND @map_scale &lt;= 1000, 1.8, IF(@map_scale > 1000 AND @map_scale &lt;= 2000, 3, 9)))" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{b3f5d845-a920-47f9-8e91-80e716dc1e73}">
        <settings calloutType="simple">
          <text-style fontSizeUnit="RenderMetersInMapUnits" fieldName="IF(string_to_array(&quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[1] IS NULL, IF( &quot;rodzajBloku&quot; = 1, &quot;numerNajwyzszejKondygnacji&quot;, IF( &quot;rodzajBloku&quot; = 2, IF(&quot;numerNajnizszejKondygnacji&quot; is not null, concat('-', to_string(&quot;numerNajnizszejKondygnacji&quot;)), ''), IF( &quot;rodzajBloku&quot; = 3 AND (&quot;numerNajnizszejKondygnacji&quot; >= 0 OR &quot;numerNajwyzszejKondygnacji&quot; >= 0), IF(&quot;numerNajwyzszejKondygnacji&quot; IS NOT NULL AND  &quot;numerNajnizszejKondygnacji&quot; IS NOT NULL, concat( &quot;numerNajnizszejKondygnacji&quot; , '/',  &quot;numerNajwyzszejKondygnacji&quot; ), ''), IF( &quot;rodzajBloku&quot; = 3 AND (&quot;numerNajnizszejKondygnacji&quot; &lt; 0 AND  &quot;numerNajwyzszejKondygnacji&quot; &lt; 0), IF(&quot;numerNajwyzszejKondygnacji&quot; IS NOT NULL AND  &quot;numerNajnizszejKondygnacji&quot; IS NOT NULL, concat('-', &quot;numerNajnizszejKondygnacji&quot; , '/-',  &quot;numerNajwyzszejKondygnacji&quot; ), ''), IF( &quot;rodzajBloku&quot; = 5, IF(&quot;numerNajwyzszejKondygnacji&quot; IS NOT NULL AND  &quot;numerNajnizszejKondygnacji&quot; IS NOT NULL, concat( &quot;numerNajnizszejKondygnacji&quot; , '/',  &quot;numerNajwyzszejKondygnacji&quot; ), ''), ''))))), string_to_array(&quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[1])" textColor="10,9,9,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" legendString="Aa" isExpression="1" multilineHeight="1" fontUnderline="0" fontWeight="50" fontKerning="1" textOpacity="1" previewBkgrdColor="255,255,255,255" fontStrikeout="0" fontLetterSpacing="0" textOrientation="horizontal" fontWordSpacing="0" fontFamily="Arial" blendMode="0" namedStyle="Normal" allowHtml="0" capitalization="0" fontItalic="0" fontSize="1.25">
            <families/>
            <text-buffer bufferOpacity="1" bufferDraw="1" bufferColor="255,255,255,255" bufferBlendMode="0" bufferJoinStyle="128" bufferSize="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="RenderMetersInMapUnits" bufferNoFill="1"/>
            <text-mask maskOpacity="1" maskedSymbolLayers="" maskSizeUnits="MM" maskEnabled="0" maskJoinStyle="128" maskSize="1.5" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
            <background shapeRadiiY="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeJoinStyle="64" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOpacity="1" shapeRotation="0" shapeRadiiUnit="MM" shapeRotationType="0" shapeOffsetUnit="MM" shapeType="0" shapeSizeUnit="MM" shapeSVGFile="" shapeFillColor="255,255,255,255" shapeSizeY="0" shapeDraw="0" shapeSizeX="0" shapeBorderWidthUnit="MM" shapeOffsetX="0" shapeOffsetY="0" shapeRadiiX="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidth="0" shapeBorderColor="128,128,128,255">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{3d2e1750-0eee-4645-9152-f118af015581}">
        <settings calloutType="simple">
          <text-style fontSizeUnit="RenderMetersInMapUnits" fieldName="IF(string_to_array(&quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[2] IS NULL, IF( &quot;rodzajBloku&quot; = 1, &quot;numerNajwyzszejKondygnacji&quot;, IF( &quot;rodzajBloku&quot; = 2, IF(&quot;numerNajnizszejKondygnacji&quot; is not null, concat('-', to_string(&quot;numerNajnizszejKondygnacji&quot;)), ''), IF( &quot;rodzajBloku&quot; = 3 AND (&quot;numerNajnizszejKondygnacji&quot; >= 0 OR &quot;numerNajwyzszejKondygnacji&quot; >= 0), IF(&quot;numerNajwyzszejKondygnacji&quot; IS NOT NULL AND  &quot;numerNajnizszejKondygnacji&quot; IS NOT NULL, concat( &quot;numerNajnizszejKondygnacji&quot; , '/',  &quot;numerNajwyzszejKondygnacji&quot; ), ''), IF( &quot;rodzajBloku&quot; = 3 AND (&quot;numerNajnizszejKondygnacji&quot; &lt; 0 AND  &quot;numerNajwyzszejKondygnacji&quot; &lt; 0), IF(&quot;numerNajwyzszejKondygnacji&quot; IS NOT NULL AND  &quot;numerNajnizszejKondygnacji&quot; IS NOT NULL, concat('-', &quot;numerNajnizszejKondygnacji&quot; , '/-',  &quot;numerNajwyzszejKondygnacji&quot; ), ''), IF( &quot;rodzajBloku&quot; = 5, IF(&quot;numerNajwyzszejKondygnacji&quot; IS NOT NULL AND  &quot;numerNajnizszejKondygnacji&quot; IS NOT NULL, concat( &quot;numerNajnizszejKondygnacji&quot; , '/',  &quot;numerNajwyzszejKondygnacji&quot; ), ''), ''))))), string_to_array(&quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[2])" textColor="10,9,9,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" legendString="Aa" isExpression="1" multilineHeight="1" fontUnderline="0" fontWeight="50" fontKerning="1" textOpacity="1" previewBkgrdColor="255,255,255,255" fontStrikeout="0" fontLetterSpacing="0" textOrientation="horizontal" fontWordSpacing="0" fontFamily="Arial" blendMode="0" namedStyle="Normal" allowHtml="0" capitalization="0" fontItalic="0" fontSize="1.25">
            <families/>
            <text-buffer bufferOpacity="1" bufferDraw="1" bufferColor="255,255,255,255" bufferBlendMode="0" bufferJoinStyle="128" bufferSize="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="RenderMetersInMapUnits" bufferNoFill="1"/>
            <text-mask maskOpacity="1" maskedSymbolLayers="" maskSizeUnits="MM" maskEnabled="0" maskJoinStyle="128" maskSize="1.5" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
            <background shapeRadiiY="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeJoinStyle="64" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOpacity="1" shapeRotation="0" shapeRadiiUnit="MM" shapeRotationType="0" shapeOffsetUnit="MM" shapeType="0" shapeSizeUnit="MM" shapeSVGFile="" shapeFillColor="255,255,255,255" shapeSizeY="0" shapeDraw="0" shapeSizeX="0" shapeBorderWidthUnit="MM" shapeOffsetX="0" shapeOffsetY="0" shapeRadiiX="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidth="0" shapeBorderColor="128,128,128,255">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{60316c18-6384-4115-96ca-dbf054d1e7a4}">
        <settings calloutType="simple">
          <text-style fontSizeUnit="RenderMetersInMapUnits" fieldName="IF(string_to_array(&quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[3] IS NULL, IF( &quot;rodzajBloku&quot; = 1, &quot;numerNajwyzszejKondygnacji&quot;, IF( &quot;rodzajBloku&quot; = 2, IF(&quot;numerNajnizszejKondygnacji&quot; is not null, concat('-', to_string(&quot;numerNajnizszejKondygnacji&quot;)), ''), IF( &quot;rodzajBloku&quot; = 3 AND (&quot;numerNajnizszejKondygnacji&quot; >= 0 OR &quot;numerNajwyzszejKondygnacji&quot; >= 0), IF(&quot;numerNajwyzszejKondygnacji&quot; IS NOT NULL AND  &quot;numerNajnizszejKondygnacji&quot; IS NOT NULL, concat( &quot;numerNajnizszejKondygnacji&quot; , '/',  &quot;numerNajwyzszejKondygnacji&quot; ), ''), IF( &quot;rodzajBloku&quot; = 3 AND (&quot;numerNajnizszejKondygnacji&quot; &lt; 0 AND  &quot;numerNajwyzszejKondygnacji&quot; &lt; 0), IF(&quot;numerNajwyzszejKondygnacji&quot; IS NOT NULL AND  &quot;numerNajnizszejKondygnacji&quot; IS NOT NULL, concat('-', &quot;numerNajnizszejKondygnacji&quot; , '/-',  &quot;numerNajwyzszejKondygnacji&quot; ), ''), IF( &quot;rodzajBloku&quot; = 5, IF(&quot;numerNajwyzszejKondygnacji&quot; IS NOT NULL AND  &quot;numerNajnizszejKondygnacji&quot; IS NOT NULL, concat( &quot;numerNajnizszejKondygnacji&quot; , '/',  &quot;numerNajwyzszejKondygnacji&quot; ), ''), ''))))), string_to_array(&quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[3])" textColor="10,9,9,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" legendString="Aa" isExpression="1" multilineHeight="1" fontUnderline="0" fontWeight="50" fontKerning="1" textOpacity="1" previewBkgrdColor="255,255,255,255" fontStrikeout="0" fontLetterSpacing="0" textOrientation="horizontal" fontWordSpacing="0" fontFamily="Arial" blendMode="0" namedStyle="Normal" allowHtml="0" capitalization="0" fontItalic="0" fontSize="1.25">
            <families/>
            <text-buffer bufferOpacity="1" bufferDraw="1" bufferColor="255,255,255,255" bufferBlendMode="0" bufferJoinStyle="128" bufferSize="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="RenderMetersInMapUnits" bufferNoFill="1"/>
            <text-mask maskOpacity="1" maskedSymbolLayers="" maskSizeUnits="MM" maskEnabled="0" maskJoinStyle="128" maskSize="1.5" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
            <background shapeRadiiY="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeJoinStyle="64" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOpacity="1" shapeRotation="0" shapeRadiiUnit="MM" shapeRotationType="0" shapeOffsetUnit="MM" shapeType="0" shapeSizeUnit="MM" shapeSVGFile="" shapeFillColor="255,255,255,255" shapeSizeY="0" shapeDraw="0" shapeSizeX="0" shapeBorderWidthUnit="MM" shapeOffsetX="0" shapeOffsetY="0" shapeRadiiX="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidth="0" shapeBorderColor="128,128,128,255">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{e75e2912-dbb3-4659-bb21-d474057a703e}">
        <settings calloutType="simple">
          <text-style fontSizeUnit="RenderMetersInMapUnits" fieldName="IF(string_to_array(&quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[4] IS NULL, IF( &quot;rodzajBloku&quot; = 1, &quot;numerNajwyzszejKondygnacji&quot;, IF( &quot;rodzajBloku&quot; = 2, IF(&quot;numerNajnizszejKondygnacji&quot; is not null, concat('-', to_string(&quot;numerNajnizszejKondygnacji&quot;)), ''), IF( &quot;rodzajBloku&quot; = 3 AND (&quot;numerNajnizszejKondygnacji&quot; >= 0 OR &quot;numerNajwyzszejKondygnacji&quot; >= 0), IF(&quot;numerNajwyzszejKondygnacji&quot; IS NOT NULL AND  &quot;numerNajnizszejKondygnacji&quot; IS NOT NULL, concat( &quot;numerNajnizszejKondygnacji&quot; , '/',  &quot;numerNajwyzszejKondygnacji&quot; ), ''), IF( &quot;rodzajBloku&quot; = 3 AND (&quot;numerNajnizszejKondygnacji&quot; &lt; 0 AND  &quot;numerNajwyzszejKondygnacji&quot; &lt; 0), IF(&quot;numerNajwyzszejKondygnacji&quot; IS NOT NULL AND  &quot;numerNajnizszejKondygnacji&quot; IS NOT NULL, concat('-', &quot;numerNajnizszejKondygnacji&quot; , '/-',  &quot;numerNajwyzszejKondygnacji&quot; ), ''), IF( &quot;rodzajBloku&quot; = 5, IF(&quot;numerNajwyzszejKondygnacji&quot; IS NOT NULL AND  &quot;numerNajnizszejKondygnacji&quot; IS NOT NULL, concat( &quot;numerNajnizszejKondygnacji&quot; , '/',  &quot;numerNajwyzszejKondygnacji&quot; ), ''), ''))))), string_to_array(&quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[4])" textColor="10,9,9,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" legendString="Aa" isExpression="1" multilineHeight="1" fontUnderline="0" fontWeight="50" fontKerning="1" textOpacity="1" previewBkgrdColor="255,255,255,255" fontStrikeout="0" fontLetterSpacing="0" textOrientation="horizontal" fontWordSpacing="0" fontFamily="Arial" blendMode="0" namedStyle="Normal" allowHtml="0" capitalization="0" fontItalic="0" fontSize="1.25">
            <families/>
            <text-buffer bufferOpacity="1" bufferDraw="1" bufferColor="255,255,255,255" bufferBlendMode="0" bufferJoinStyle="128" bufferSize="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="RenderMetersInMapUnits" bufferNoFill="1"/>
            <text-mask maskOpacity="1" maskedSymbolLayers="" maskSizeUnits="MM" maskEnabled="0" maskJoinStyle="128" maskSize="1.5" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
            <background shapeRadiiY="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeJoinStyle="64" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOpacity="1" shapeRotation="0" shapeRadiiUnit="MM" shapeRotationType="0" shapeOffsetUnit="MM" shapeType="0" shapeSizeUnit="MM" shapeSVGFile="" shapeFillColor="255,255,255,255" shapeSizeY="0" shapeDraw="0" shapeSizeX="0" shapeBorderWidthUnit="MM" shapeOffsetX="0" shapeOffsetY="0" shapeRadiiX="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidth="0" shapeBorderColor="128,128,128,255">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{8f885059-e885-4d08-a6fd-c02eda375232}">
        <settings calloutType="simple">
          <text-style fontSizeUnit="RenderMetersInMapUnits" fieldName="IF(string_to_array(&quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[5] IS NULL, IF( &quot;rodzajBloku&quot; = 1, &quot;numerNajwyzszejKondygnacji&quot;, IF( &quot;rodzajBloku&quot; = 2, IF(&quot;numerNajnizszejKondygnacji&quot; is not null, concat('-', to_string(&quot;numerNajnizszejKondygnacji&quot;)), ''), IF( &quot;rodzajBloku&quot; = 3 AND (&quot;numerNajnizszejKondygnacji&quot; >= 0 OR &quot;numerNajwyzszejKondygnacji&quot; >= 0), IF(&quot;numerNajwyzszejKondygnacji&quot; IS NOT NULL AND  &quot;numerNajnizszejKondygnacji&quot; IS NOT NULL, concat( &quot;numerNajnizszejKondygnacji&quot; , '/',  &quot;numerNajwyzszejKondygnacji&quot; ), ''), IF( &quot;rodzajBloku&quot; = 3 AND (&quot;numerNajnizszejKondygnacji&quot; &lt; 0 AND  &quot;numerNajwyzszejKondygnacji&quot; &lt; 0), IF(&quot;numerNajwyzszejKondygnacji&quot; IS NOT NULL AND  &quot;numerNajnizszejKondygnacji&quot; IS NOT NULL, concat('-', &quot;numerNajnizszejKondygnacji&quot; , '/-',  &quot;numerNajwyzszejKondygnacji&quot; ), ''), IF( &quot;rodzajBloku&quot; = 5, IF(&quot;numerNajwyzszejKondygnacji&quot; IS NOT NULL AND  &quot;numerNajnizszejKondygnacji&quot; IS NOT NULL, concat( &quot;numerNajnizszejKondygnacji&quot; , '/',  &quot;numerNajwyzszejKondygnacji&quot; ), ''), ''))))), string_to_array(&quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[5])" textColor="10,9,9,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" legendString="Aa" isExpression="1" multilineHeight="1" fontUnderline="0" fontWeight="50" fontKerning="1" textOpacity="1" previewBkgrdColor="255,255,255,255" fontStrikeout="0" fontLetterSpacing="0" textOrientation="horizontal" fontWordSpacing="0" fontFamily="Arial" blendMode="0" namedStyle="Normal" allowHtml="0" capitalization="0" fontItalic="0" fontSize="1.25">
            <families/>
            <text-buffer bufferOpacity="1" bufferDraw="1" bufferColor="255,255,255,255" bufferBlendMode="0" bufferJoinStyle="128" bufferSize="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="RenderMetersInMapUnits" bufferNoFill="1"/>
            <text-mask maskOpacity="1" maskedSymbolLayers="" maskSizeUnits="MM" maskEnabled="0" maskJoinStyle="128" maskSize="1.5" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
            <background shapeRadiiY="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeJoinStyle="64" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOpacity="1" shapeRotation="0" shapeRadiiUnit="MM" shapeRotationType="0" shapeOffsetUnit="MM" shapeType="0" shapeSizeUnit="MM" shapeSVGFile="" shapeFillColor="255,255,255,255" shapeSizeY="0" shapeDraw="0" shapeSizeX="0" shapeBorderWidthUnit="MM" shapeOffsetX="0" shapeOffsetY="0" shapeRadiiX="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidth="0" shapeBorderColor="128,128,128,255">
