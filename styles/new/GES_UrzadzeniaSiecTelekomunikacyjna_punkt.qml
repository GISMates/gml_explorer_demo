    ...
    <symbols>
      ...
      <symbol type="marker" alpha="1" name="2" clip_to_extent="1" force_rhr="0">
        ...
        <layer enabled="1" pass="0" locked="0" class="SvgMarker">
          ...
          <prop v="1" k="horizontal_anchor_point"/>
          <prop v="C:/Users/wizipisi/AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins/gml_explorer_dev/symbols/Wieza_telekomunikacyjna_SUTW.svg" k="name"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
