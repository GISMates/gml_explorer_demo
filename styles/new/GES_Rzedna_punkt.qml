...
<qgis styleCategories="Symbology|Labeling|Actions" labelsEnabled="1" version="3.22.12-Białowieża">
  ...
  <labeling type="rule-based">
    <rules key="{1b409325-1a02-4a18-910e-5e151db6bf41}">
      <rule filter="IF(&quot;PrezentacjaGraficzna_geometria&quot;, &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True)" key="{9c4a7d89-3e0a-411c-b5c6-b80ea637309e}" scalemaxdenom="1001" description="Prezentacja graficzna" scalemindenom="1">
