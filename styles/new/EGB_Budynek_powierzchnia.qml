...
<qgis version="3.22.12-Białowieża" styleCategories="Symbology|Labeling|Actions" labelsEnabled="1">
  ...
  <labeling type="rule-based">
    <rules key="{7cd02d99-35fc-43fe-a419-5a86e9bd870a}">
      <rule filter=" IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True), True), True)" description="Prezentacja graficzna" key="{370455bb-f6d7-48ef-aa5c-e63ef2098676}" scalemaxdenom="1001" scalemindenom="1">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" isExpression="1" textOpacity="1" blendMode="0" multilineHeight="1" capitalization="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Normal" fontSizeUnit="RenderMetersInMapUnits" fontStrikeout="0" textColor="0,0,0,255" legendString="Aa" fontWeight="50" textOrientation="horizontal" fontUnderline="0" fontWordSpacing="0" fontFamily="Arial" fontLetterSpacing="0" fieldName="IF(&quot;liczbaKondygnacjiNadziemnych&quot; > 0 OR (&quot;liczbaKondygnacjiNadziemnych&quot; IS NULL AND (&quot;liczbaKondygnacjiPodziemnych&quot; = 0 OR &quot;liczbaKondygnacjiPodziemnych&quot; IS NULL)), concat(&quot;rodzajWgKST&quot;,  &quot;liczbaKondygnacjiNadziemnych&quot;), IF(&quot;liczbaKondygnacjiPodziemnych&quot; > 0 AND (&quot;liczbaKondygnacjiNadziemnych&quot; = 0 OR &quot;liczbaKondygnacjiNadziemnych&quot; IS NULL), concat(&quot;rodzajWgKST&quot;, '-',  &quot;liczbaKondygnacjiPodziemnych&quot;), ''))" fontSize="1" allowHtml="0" useSubstitutions="0" fontKerning="1" fontItalic="0">
            <families/>
      ...
      <rule filter=" IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True), True), True)" description="Prezentacja graficzna" key="{3ac99ecb-35a1-435f-966a-d1bb223f96a4}" scalemaxdenom="1001" scalemindenom="1">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" isExpression="1" textOpacity="1" blendMode="0" multilineHeight="1" capitalization="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Normal" fontSizeUnit="RenderMetersInMapUnits" fontStrikeout="0" textColor="0,0,0,255" legendString="Aa" fontWeight="50" textOrientation="horizontal" fontUnderline="0" fontWordSpacing="0" fontFamily="Arial" fontLetterSpacing="0" fieldName="IF(&quot;liczbaKondygnacjiNadziemnych&quot; > 0 OR (&quot;liczbaKondygnacjiNadziemnych&quot; IS NULL AND (&quot;liczbaKondygnacjiPodziemnych&quot; = 0 OR &quot;liczbaKondygnacjiPodziemnych&quot; IS NULL)), concat(&quot;rodzajWgKST&quot;,  &quot;liczbaKondygnacjiNadziemnych&quot;), IF(&quot;liczbaKondygnacjiPodziemnych&quot; > 0 AND (&quot;liczbaKondygnacjiNadziemnych&quot; = 0 OR &quot;liczbaKondygnacjiNadziemnych&quot; IS NULL), concat(&quot;rodzajWgKST&quot;, '-',  &quot;liczbaKondygnacjiPodziemnych&quot;), ''))" fontSize="1" allowHtml="0" useSubstitutions="0" fontKerning="1" fontItalic="0">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0" bufferSize="0" bufferJoinStyle="128" bufferOpacity="1" bufferDraw="1" bufferColor="255,255,255,255" bufferNoFill="1" bufferSizeUnits="RenderMetersInMapUnits"/>
      ...
      <rule filter=" IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True), True), True)" description="Prezentacja graficzna" key="{48f2a302-8213-472a-8645-c52dae9a65ff}" scalemaxdenom="1001" scalemindenom="1">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" isExpression="1" textOpacity="1" blendMode="0" multilineHeight="1" capitalization="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Normal" fontSizeUnit="RenderMetersInMapUnits" fontStrikeout="0" textColor="0,0,0,255" legendString="Aa" fontWeight="50" textOrientation="horizontal" fontUnderline="0" fontWordSpacing="0" fontFamily="Arial" fontLetterSpacing="0" fieldName="IF(&quot;liczbaKondygnacjiNadziemnych&quot; > 0 OR (&quot;liczbaKondygnacjiNadziemnych&quot; IS NULL AND (&quot;liczbaKondygnacjiPodziemnych&quot; = 0 OR &quot;liczbaKondygnacjiPodziemnych&quot; IS NULL)), concat(&quot;rodzajWgKST&quot;,  &quot;liczbaKondygnacjiNadziemnych&quot;), IF(&quot;liczbaKondygnacjiPodziemnych&quot; > 0 AND (&quot;liczbaKondygnacjiNadziemnych&quot; = 0 OR &quot;liczbaKondygnacjiNadziemnych&quot; IS NULL), concat(&quot;rodzajWgKST&quot;, '-',  &quot;liczbaKondygnacjiPodziemnych&quot;), ''))" fontSize="1" allowHtml="0" useSubstitutions="0" fontKerning="1" fontItalic="0">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0" bufferSize="0" bufferJoinStyle="128" bufferOpacity="1" bufferDraw="1" bufferColor="255,255,255,255" bufferNoFill="1" bufferSizeUnits="RenderMetersInMapUnits"/>
      ...
      <rule filter=" IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True), True), True)" description="Prezentacja graficzna" key="{7bf26901-1360-4d3b-a834-7371cf4d8ac4}" scalemaxdenom="1001" scalemindenom="1">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" isExpression="1" textOpacity="1" blendMode="0" multilineHeight="1" capitalization="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Normal" fontSizeUnit="RenderMetersInMapUnits" fontStrikeout="0" textColor="0,0,0,255" legendString="Aa" fontWeight="50" textOrientation="horizontal" fontUnderline="0" fontWordSpacing="0" fontFamily="Arial" fontLetterSpacing="0" fieldName="IF(&quot;liczbaKondygnacjiNadziemnych&quot; > 0 OR (&quot;liczbaKondygnacjiNadziemnych&quot; IS NULL AND (&quot;liczbaKondygnacjiPodziemnych&quot; = 0 OR &quot;liczbaKondygnacjiPodziemnych&quot; IS NULL)), concat(&quot;rodzajWgKST&quot;,  &quot;liczbaKondygnacjiNadziemnych&quot;), IF(&quot;liczbaKondygnacjiPodziemnych&quot; > 0 AND (&quot;liczbaKondygnacjiNadziemnych&quot; = 0 OR &quot;liczbaKondygnacjiNadziemnych&quot; IS NULL), concat(&quot;rodzajWgKST&quot;, '-',  &quot;liczbaKondygnacjiPodziemnych&quot;), ''))" fontSize="1" allowHtml="0" useSubstitutions="0" fontKerning="1" fontItalic="0">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0" bufferSize="0" bufferJoinStyle="128" bufferOpacity="1" bufferDraw="1" bufferColor="255,255,255,255" bufferNoFill="1" bufferSizeUnits="RenderMetersInMapUnits"/>
      ...
      <rule filter=" IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True), True), True)" description="Prezentacja graficzna" key="{e2e76fbd-72db-4deb-9e33-54ab18a422a2}" scalemaxdenom="1001" scalemindenom="1">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" isExpression="1" textOpacity="1" blendMode="0" multilineHeight="1" capitalization="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Normal" fontSizeUnit="RenderMetersInMapUnits" fontStrikeout="0" textColor="0,0,0,255" legendString="Aa" fontWeight="50" textOrientation="horizontal" fontUnderline="0" fontWordSpacing="0" fontFamily="Arial" fontLetterSpacing="0" fieldName="IF(&quot;liczbaKondygnacjiNadziemnych&quot; > 0 OR (&quot;liczbaKondygnacjiNadziemnych&quot; IS NULL AND (&quot;liczbaKondygnacjiPodziemnych&quot; = 0 OR &quot;liczbaKondygnacjiPodziemnych&quot; IS NULL)), concat(&quot;rodzajWgKST&quot;,  &quot;liczbaKondygnacjiNadziemnych&quot;), IF(&quot;liczbaKondygnacjiPodziemnych&quot; > 0 AND (&quot;liczbaKondygnacjiNadziemnych&quot; = 0 OR &quot;liczbaKondygnacjiNadziemnych&quot; IS NULL), concat(&quot;rodzajWgKST&quot;, '-',  &quot;liczbaKondygnacjiPodziemnych&quot;), ''))" fontSize="1" allowHtml="0" useSubstitutions="0" fontKerning="1" fontItalic="0">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0" bufferSize="0" bufferJoinStyle="128" bufferOpacity="1" bufferDraw="1" bufferColor="255,255,255,255" bufferNoFill="1" bufferSizeUnits="RenderMetersInMapUnits"/>
