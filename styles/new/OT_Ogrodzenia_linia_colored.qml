...
<qgis labelsEnabled="0" version="3.22.12-Białowieża" styleCategories="Symbology|Labeling|Actions">
  <renderer-v2 referencescale="-1" type="RuleRenderer" forceraster="0" symbollevels="0" enableorderby="0">
    <rules key="{317072a3-8198-426e-bf6e-e6188a436ba8}">
      <rule label="ogrodzenie trwałe OTOO" scalemindenom="1" filter=" &quot;rodzajOgrodzenia&quot; = 'o'" scalemaxdenom="1001" key="{2680092f-ca7f-4c4a-9679-0ebff30b50ef}" symbol="0"/>
      <rule label="brama OTOB" scalemindenom="1" filter=" &quot;rodzajOgrodzenia&quot; = 'b'" scalemaxdenom="1001" key="{5aec0057-a765-43b0-80b9-24e87af18f41}" symbol="1"/>
      <rule label="furtka OTOF" scalemindenom="1" filter=" &quot;rodzajOgrodzenia&quot; = 'f'" scalemaxdenom="1001" key="{d394a9fe-cabd-40b1-ad36-9bb4b7feb2e9}" symbol="2"/>
    </rules>
    <symbols>
      <symbol name="0" alpha="1" clip_to_extent="1" type="line" force_rhr="0">
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="outlineWidth" type="Map">
                  ...
                  <Option name="expression" type="QString" value="IF( @map_scale &lt;= 500, 0.175, 0.35)"/>
        ...
        <layer locked="0" enabled="1" class="MarkerLine" pass="0">
          <Option type="Map">
            ...
            <Option name="interval" type="QString" value="7.5"/>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="interval" type="Map">
                  <Option name="active" type="bool" value="true"/>
                  <Option name="expression" type="QString" value="IF( @map_scale &lt;= 500, 7.5, 11.25)"/>
                  <Option name="type" type="int" value="3"/>
                </Option>
                <Option name="offsetAlongLine" type="Map">
                  <Option name="active" type="bool" value="true"/>
                  <Option name="expression" type="QString" value="IF( @map_scale &lt;= 500, 7.5, 15)"/>
                  <Option name="type" type="int" value="3"/>
                </Option>
              </Option>
              <Option name="type" type="QString" value="collection"/>
          ...
          <symbol name="@0@1" alpha="1" clip_to_extent="1" type="marker" force_rhr="0">
            ...
            <layer locked="0" enabled="1" class="SimpleMarker" pass="0">
              <Option type="Map">
                ...
                <Option name="size" type="QString" value="0.35"/>
                ...
                <Option type="Map">
                  ...
                  <Option name="properties" type="Map">
                    <Option name="size" type="Map">
                      <Option name="active" type="bool" value="true"/>
                      <Option name="expression" type="QString" value="IF( @map_scale &lt;= 500, 0.35, 0.525)"/>
                      <Option name="type" type="int" value="3"/>
                    </Option>
                  </Option>
                  <Option name="type" type="QString" value="collection"/>
        ...
        <layer locked="0" enabled="1" class="MarkerLine" pass="0">
          ...
          <symbol name="@0@2" alpha="1" clip_to_extent="1" type="marker" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
        ...
        <layer locked="0" enabled="1" class="MarkerLine" pass="0">
          ...
          <symbol name="@0@3" alpha="1" clip_to_extent="1" type="marker" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
                ...
                <Option type="Map">
                  ...
                  <Option name="properties" type="Map">
                    <Option name="offset" type="Map">
                      <Option name="active" type="bool" value="true"/>
                      <Option name="expression" type="QString" value="IF( @map_scale &lt;= 500, '-0,-0.6', '0,-0.8')"/>
                      <Option name="type" type="int" value="3"/>
                    </Option>
                    <Option name="width" type="Map">
                      <Option name="active" type="bool" value="true"/>
                      <Option name="expression" type="QString" value="IF( @map_scale &lt;= 500, 1.5, 2.25)"/>
                      <Option name="type" type="int" value="3"/>
                    </Option>
                  </Option>
                  <Option name="type" type="QString" value="collection"/>
              ...
              <data_defined_properties>
                <Option type="Map">
                  ...
                  <Option name="properties" type="Map">
                    <Option name="offset" type="Map">
                      <Option name="active" type="bool" value="true"/>
                      <Option name="expression" type="QString" value="IF( @map_scale &lt;= 500, '-0.05,-0.6', '0,-0.8')"/>
                      <Option name="type" type="int" value="3"/>
                    </Option>
                    <Option name="width" type="Map">
                      <Option name="active" type="bool" value="true"/>
                      <Option name="expression" type="QString" value="IF( @map_scale &lt;= 500, 0.75, 1.125)"/>
                      <Option name="type" type="int" value="3"/>
                    </Option>
                  </Option>
                  <Option name="type" type="QString" value="collection"/>
