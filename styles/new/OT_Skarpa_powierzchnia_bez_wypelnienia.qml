...
<qgis version="3.22.12-Białowieża" labelsEnabled="0" styleCategories="Symbology|Labeling">
  <renderer-v2 type="RuleRenderer" symbollevels="0" referencescale="-1" forceraster="0" enableorderby="0">
    <rules key="{2ef9e740-4b75-419e-bec2-38194402a084}">
      <rule symbol="0" scalemaxdenom="1001" label="skarpa umocniona OTRU" filter=" &quot;rodzajSkarpy&quot; = 'u'" scalemindenom="1" key="{e2774581-3026-4c43-a9be-b12cc85c0879}"/>
      <rule symbol="1" scalemaxdenom="1001" label="skarpa nieumocniona OTRK" filter=" &quot;rodzajSkarpy&quot; = 'k'" scalemindenom="1" key="{bf44d3f7-8a51-47b9-a61d-12bf7973b456}"/>
    </rules>
    <symbols>
