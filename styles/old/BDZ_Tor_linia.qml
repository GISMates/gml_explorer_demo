...
<qgis version="3.22.4-Białowieża" styleCategories="Symbology|Labeling" labelsEnabled="0">
  <renderer-v2 type="RuleRenderer" referencescale="-1" enableorderby="0" forceraster="0" symbollevels="0">
    <rules key="{3c72c234-9807-47e1-be8c-657677b198b8}">
      <rule symbol="0" label="tor kolejowy KTTR01" key="{392359b9-859c-418f-8d28-36a17cc94f56}" filter=" &quot;rodzajTor&quot; = 'torKolejowy' "/>
      <rule symbol="1" label="tor metra KTTR02" key="{39d111cb-6d55-4b15-baa6-c9427e0021bb}" filter=" &quot;rodzajTor&quot; = 'torMetra'"/>
      <rule symbol="2" label="tor tramwajowy KTTR03" key="{9b29aeb7-4c1d-410c-8fb5-6b2a02112d06}" filter=" &quot;rodzajTor&quot; = 'torTramwajowy'"/>
    </rules>
    <symbols>
