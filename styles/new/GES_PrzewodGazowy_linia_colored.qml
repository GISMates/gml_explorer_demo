      ...
      <rule scalemindenom="1" filter=" IF( presentationFieldExists(), &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True)" key="{c2364eab-a080-41be-9fc6-b823e3964678}" scalemaxdenom="2001" description="Prezentacja graficzna">
        <settings calloutType="simple">
          <text-style fieldName="generateWireLabelNew( @layer_name )" useSubstitutions="0" fontWeight="50" fontItalic="0" fontFamily="Arial" fontWordSpacing="0" fontLetterSpacing="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" textColor="0,170,0,255" blendMode="0" previewBkgrdColor="255,255,255,255" textOrientation="horizontal" legendString="Aa" fontSize="0.75" allowHtml="0" namedStyle="Normal" fontSizeUnit="RenderMetersInMapUnits" textOpacity="1" multilineHeight="1" isExpression="1" fontStrikeout="0" fontUnderline="0" fontKerning="1">
            ...
            <background shapeSizeType="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiUnit="MM" shapeRadiiX="0" shapeRadiiY="0" shapeRotation="0" shapeType="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidth="0" shapeBorderWidthUnit="MM" shapeOffsetX="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetY="0" shapeSizeUnit="MM" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeX="0" shapeFillColor="255,255,255,255" shapeBorderColor="0,170,0,255" shapeRotationType="0" shapeDraw="0" shapeOffsetUnit="MM" shapeSizeY="0" shapeBlendMode="0" shapeOpacity="1" shapeSVGFile="" shapeJoinStyle="64">
