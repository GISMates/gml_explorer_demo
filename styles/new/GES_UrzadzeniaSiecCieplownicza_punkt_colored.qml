...
<qgis styleCategories="Symbology|Labeling" version="3.22.4-Białowieża" labelsEnabled="1">
  <renderer-v2 type="RuleRenderer" forceraster="0" enableorderby="0" symbollevels="0" referencescale="-1">
    <rules key="{3ef8e849-a934-42ce-a5fb-fb3294fef8bc}">
      <rule symbol="0" filter=" &quot;rodzajUrzadzenia&quot; = 'u'" scalemindenom="1" scalemaxdenom="1001" label="ciepłownicze urządzenie techniczne SUCU" key="{74129de9-f301-4bb3-9ce1-c1332d4b1006}"/>
      <rule symbol="1" filter=" &quot;rodzajUrzadzenia&quot; = 'w'" scalemindenom="1" scalemaxdenom="1001" label="zasuwa lub zawór SUCW" key="{e9d36f62-6664-471f-bea0-29426a236fc2}"/>
    </rules>
    <symbols>
      <symbol type="marker" alpha="1" name="0" clip_to_extent="1" force_rhr="0">
        ...
        <layer enabled="1" pass="0" locked="0" class="SimpleMarker">
          <Option type="Map">
            ...
            <Option type="QString" value="252,217,79,255" name="color"/>
            ...
            <Option type="QString" value="252,217,79,255" name="outline_color"/>
          ...
          <prop v="252,217,79,255" k="outline_color"/>
  ...
  <labeling type="rule-based">
    <rules key="{ad7f7026-ca02-4582-aa05-6074f7d07ed0}">
      <rule filter=" IF(&quot;PrezentacjaGraficzna_geometria&quot;, &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True)" scalemindenom="1" scalemaxdenom="1001" key="{248263f4-feb2-4f19-8f11-622af0165ee7}" description="Prezentacja graficzna">
        <settings calloutType="simple">
          <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontFamily="Arial" namedStyle="Normal" fontWordSpacing="0" isExpression="1" fontLetterSpacing="0" textOrientation="horizontal" multilineHeight="1" allowHtml="0" fieldName="IF(&quot;status&quot; = 'p', 'proj. c', 'c')" textColor="252,217,79,255" textOpacity="1" fontSize="0.75" useSubstitutions="0" legendString="Aa" capitalization="0" fontItalic="0" fontKerning="1" fontUnderline="0" blendMode="0" fontSizeUnit="RenderMetersInMapUnits" fontStrikeout="0" fontWeight="50" previewBkgrdColor="255,255,255,255">
            <families/>
            ...
            <background shapeRotationType="0" shapeOffsetY="0" shapeRadiiX="0" shapeOffsetUnit="MM" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeUnit="MM" shapeSizeY="0" shapeRotation="0" shapeType="0" shapeDraw="0" shapeOffsetX="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidthUnit="MM" shapeBlendMode="0" shapeBorderColor="252,217,79,255" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidth="0" shapeSVGFile="" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOpacity="1" shapeFillColor="255,255,255,255" shapeRadiiUnit="MM" shapeSizeX="0" shapeSizeType="0" shapeRadiiY="0" shapeJoinStyle="64">
            ...
            <shadow shadowUnder="0" shadowOffsetDist="1" shadowRadiusUnit="MM" shadowScale="100" shadowOffsetAngle="135" shadowRadiusAlphaOnly="0" shadowOffsetUnit="MM" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowOpacity="0.69999999999999996" shadowRadius="1.5" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowColor="252,217,79,255" shadowOffsetGlobal="1" shadowBlendMode="6" shadowDraw="0"/>
            <dd_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
