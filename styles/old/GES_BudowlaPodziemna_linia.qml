...
<qgis version="3.22.4-Białowieża" styleCategories="Symbology|Labeling|Actions" labelsEnabled="1">
  <renderer-v2 referencescale="-1" enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{e9d5a706-0c0d-4623-baee-e4b3f5560175}">
      <rule scalemindenom="1" symbol="0" filter="coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy' AND &quot;rodzajBudowli&quot; = 'komoraPodziemna'" scalemaxdenom="1001" key="{b2ae57ee-f622-4c1f-95a7-6d8d06c687ed}" label="komora podziemna SUBP02_0x"/>
      <rule scalemindenom="1" symbol="1" filter="coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy' AND &quot;rodzajBudowli&quot; = 'osadnik'" scalemaxdenom="2001" key="{538c3202-fa15-4f5e-b0fa-3e9f3f3c9d25}" label="osadnik SUBP03"/>
      <rule symbol="2" filter="coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy' AND &quot;rodzajBudowli&quot; = 'przejsciePodziemne'" key="{9a8a245a-3a1d-4868-88d1-85b80b333858}" label="przejście podziemne SUBP05"/>
      <rule symbol="3" filter="coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy' AND &quot;rodzajBudowli&quot; = 'tunelDrogowy'" key="{88feab6b-566d-45bc-a2a8-84a5a7e6b5ac}" label="tunel drogowy SUBP06"/>
      <rule symbol="4" filter="coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy' AND &quot;rodzajBudowli&quot; = 'tunelKolejowy'" key="{41b9a20c-ce0a-484d-acad-f8042998c29d}" label="tunel kolejowy SUBP07"/>
      <rule symbol="5" filter="coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy' AND &quot;rodzajBudowli&quot; = 'tunelMetra'" key="{faa019d9-0b53-435a-9722-3bdff667fab1}" label="tunel metra SUBP08"/>
      <rule symbol="6" filter="coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy' AND &quot;rodzajBudowli&quot; = 'tunelTramwajowy'" key="{d0ce1c14-759b-4bcd-871c-535cfbf70fff}" label="tunel tramwajowy SUBP09"/>
      <rule symbol="7" filter="coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy' AND &quot;rodzajBudowli&quot; = 'inna'" key="{35dedfa0-e928-490c-9149-d828b14584b8}" label="inna budowla podziemna SUBP10"/>
      <rule symbol="8" filter="coalesce(&quot;istnienie&quot;, 'istniejacy') IN('projektowany', 'wBudowie')" key="{f4ed8924-f454-4126-b766-dcca1aa3291c}" label="budowla podziemna - projektowana lub w budowie SUBP_P"/>
    </rules>
    <symbols>
      <symbol alpha="1" name="0" force_rhr="0" clip_to_extent="1" type="line">
        ...
        <layer locked="0" enabled="1" pass="0" class="SimpleLine">
          <Option type="Map">
            ...
            <Option name="line_color" value="10,9,9,255" type="QString"/>
  ...
  <labeling type="rule-based">
    <rules key="{663ad398-c136-4567-be56-60d310a95d6c}">
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{1a6cbeac-d0ef-4b7f-89b1-4d350121f813}">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{548b9cc9-c2db-4cbf-8746-9f5c4118da4d}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{6ceda001-ee13-4ab9-b0a2-f2c5a8e0bd8e}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{3ba6db66-88a4-46e7-a290-557cd1f30ddb}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{17e8fe72-2711-44c5-8d93-9b7db103faec}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{84f30690-ed62-4799-bd6f-032f95edba70}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{8c9c0cd9-759e-4db4-9314-5a7446ed4fee}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{7fbc21fa-d147-4097-8380-2eab5246bcfd}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{d51fa5ff-ca20-49da-9efa-31e3fd515aa9}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{1871c931-4f2e-4ce1-9412-3ee5be1f77ae}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{088bdc25-a65b-4081-b6c0-7bf1105253a4}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{15067466-d652-4e42-80b2-92e76efcb8cf}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{b1c784b5-27e8-4c79-bbfa-587e96822b97}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{b1e8172f-12c8-42f6-837b-02c2094127f3}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{89a36dbd-7507-42b7-8969-207cac6df5ef}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{5c0c2205-bb07-4fe9-91fd-4706732400e3}">
        <settings calloutType="simple">
