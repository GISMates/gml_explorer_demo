...
<qgis version="3.22.4-Białowieża" styleCategories="Symbology|Labeling|Actions" labelsEnabled="1">
  <renderer-v2 referencescale="-1" enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{6189860c-f783-4145-a5f9-c7fbe370881b}">
      <rule symbol="0" filter="IF (@map_scale &lt;= 500, coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy' AND (&quot;srednica&quot; IS NULL OR &quot;srednica&quot;/1000 &lt;= 0.75), IF(@map_scale > 2000, coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy' AND (&quot;przebieg&quot; IS NULL OR &quot;przebieg&quot; IN('naziemny', 'nadziemny')), coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy'))" key="{17b0aab9-96d7-4a56-8020-c9ebc7055cad}" label="przewód benzynowy SUPB_01"/>
      <rule scalemindenom="1" symbol="1" filter=" coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy' AND &quot;srednica&quot; IS NOT NULL AND &quot;srednica&quot;/1000 > 0.75" scalemaxdenom="501" key="{4ac38f4e-64a1-49d1-a0f2-91523b56b2e9}" label="przewód benzynowy SUPB_02"/>
      <rule scalemindenom="1" symbol="2" filter="IF (@map_scale &lt;= 500, coalesce(&quot;istnienie&quot;, 'istniejacy') IN ('projektowany', 'wBudowie') AND (&quot;srednica&quot; IS NULL OR &quot;srednica&quot;/1000 &lt;= 0.75), coalesce(&quot;istnienie&quot;, 'istniejacy') IN ('projektowany', 'wBudowie'))" scalemaxdenom="1001" key="{9f838146-e704-4206-aed5-c16033ac42c5}" label="przewód benzynowy - projektowany lub w budowie SUPB_P_01"/>
      <rule scalemindenom="1" symbol="3" filter=" coalesce(&quot;istnienie&quot;, 'istniejacy') IN ('projektowany', 'wBudowie') AND &quot;srednica&quot; IS NOT NULL AND &quot;srednica&quot;/1000 > 0.75" scalemaxdenom="501" key="{665618df-0093-4d15-89e0-f39559bc90ff}" label="przewód benzynowy - projektowany lub w budowie SUPB_P_02"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{c097e1c7-347e-4b4c-ac84-ef471eb4eb46}">
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{78e866f9-cf5d-4b4d-b09b-e432039d8073}">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{e406f05f-f509-4c9f-ba3d-713bab7bacc8}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{10a73bbc-5b8c-4992-ba3d-ab18c720a2d1}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{d7ce3f10-31d1-4367-b955-af23b6473410}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{f4d29c3a-a81c-4d93-86ed-1f0ec0be5663}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{2d6ecb5c-4831-46a7-8244-5b3bdf9c3179}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{e19af548-3cbb-4a24-8a4d-d48ecdb0c6f0}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{f97c69c3-defa-4785-a4a2-b19dd5faca73}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{f79bbfaa-5da3-444a-ad8e-a2c8a93e4f3d}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{5966fdcf-5538-4d47-8071-2ed6641b1b52}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{49dc2275-5982-45ea-b8e9-d6573c8138fb}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{234160c1-93b4-405b-9381-2f630f1cd14d}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{eabbe8e3-d02e-4e1e-a209-a04138d53827}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{ed8b18dc-f106-4192-a0ec-ceaa114a0abf}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{9f6f2d36-a2ca-4b12-b5cf-815d7766d9d4}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{bc90e3be-7319-4243-bd10-c5d7e5756700}">
        <settings calloutType="simple">
