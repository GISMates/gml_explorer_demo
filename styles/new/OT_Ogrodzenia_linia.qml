...
<qgis labelsEnabled="0" styleCategories="Symbology|Labeling|Actions" version="3.22.4-Białowieża">
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{317072a3-8198-426e-bf6e-e6188a436ba8}">
      <rule filter=" &quot;rodzajOgrodzenia&quot; = 'o'" scalemindenom="1" key="{2680092f-ca7f-4c4a-9679-0ebff30b50ef}" symbol="0" label="ogrodzenie trwałe OTOO" scalemaxdenom="1001"/>
      <rule filter=" &quot;rodzajOgrodzenia&quot; = 'b'" scalemindenom="1" key="{5aec0057-a765-43b0-80b9-24e87af18f41}" symbol="1" label="brama OTOB" scalemaxdenom="1001"/>
      <rule filter=" &quot;rodzajOgrodzenia&quot; = 'f'" scalemindenom="1" key="{d394a9fe-cabd-40b1-ad36-9bb4b7feb2e9}" symbol="2" label="furtka OTOF" scalemaxdenom="1001"/>
    </rules>
    <symbols>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="interval" type="Map">
                  <Option name="active" value="true" type="bool"/>
                  <Option name="expression" value="IF( @map_scale &lt;= 500, 7.5, 11.25)" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
                <Option name="offsetAlongLine" type="Map">
                  <Option name="active" value="true" type="bool"/>
                  <Option name="expression" value="IF( @map_scale &lt;= 500, 7.5, 15)" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
              </Option>
              <Option name="type" value="collection" type="QString"/>
                ...
                <Option type="Map">
                  ...
                  <Option name="properties" type="Map">
                    <Option name="size" type="Map">
                      <Option name="active" value="true" type="bool"/>
                      <Option name="expression" value="IF( @map_scale &lt;= 500, 0.35, 0.525)" type="QString"/>
                      <Option name="type" value="3" type="int"/>
                    </Option>
                  </Option>
                  <Option name="type" value="collection" type="QString"/>
          ...
          <symbol name="@1@1" clip_to_extent="1" alpha="1" force_rhr="0" type="marker">
            ...
            <layer class="SvgMarker" locked="0" enabled="1" pass="0">
              <Option type="Map">
                ...
                <Option name="horizontal_anchor_point" value="1" type="QString"/>
                <Option name="name" value="C:/Users/wizipisi/AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins/gml_explorer_dev/symbols/brama.svg" type="QString"/>
                ...
                <Option type="Map">
                  ...
                  <Option name="properties" type="Map">
                    <Option name="offset" type="Map">
                      <Option name="active" value="true" type="bool"/>
                      <Option name="expression" value="IF( @map_scale &lt;= 500, '-0,-0.6', '0,-0.8')" type="QString"/>
                      <Option name="type" value="3" type="int"/>
                    </Option>
                    <Option name="width" type="Map">
                      <Option name="active" value="true" type="bool"/>
                      <Option name="expression" value="IF( @map_scale &lt;= 500, 1.5, 2.25)" type="QString"/>
                      <Option name="type" value="3" type="int"/>
                    </Option>
                  </Option>
                  <Option name="type" value="collection" type="QString"/>
          ...
          <symbol name="@2@1" clip_to_extent="1" alpha="1" force_rhr="0" type="marker">
            ...
            <layer class="SvgMarker" locked="0" enabled="1" pass="0">
              <Option type="Map">
                ...
                <Option name="name" value="C:/Users/wizipisi/AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins/gml_explorer_dev/symbols/furtka.svg" type="QString"/>
                <Option name="offset" value="-0.05,-0.59999999999999998" type="QString"/>
                <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
                <Option name="offset_unit" value="RenderMetersInMapUnits" type="QString"/>
                <Option name="outline_color" value="35,35,35,255" type="QString"/>
                <Option name="outline_width" value="0" type="QString"/>
              ...
              <data_defined_properties>
                <Option type="Map">
                  ...
                  <Option name="properties" type="Map">
                    <Option name="offset" type="Map">
                      <Option name="active" value="true" type="bool"/>
                      <Option name="expression" value="IF( @map_scale &lt;= 500, '-0.05,-0.6', '0,-0.8')" type="QString"/>
                      <Option name="type" value="3" type="int"/>
                    </Option>
                    <Option name="width" type="Map">
                      <Option name="active" value="true" type="bool"/>
                      <Option name="expression" value="IF( @map_scale &lt;= 500, 0.75, 1.125)" type="QString"/>
                      <Option name="type" value="3" type="int"/>
                    </Option>
                  </Option>
                  <Option name="type" value="collection" type="QString"/>
