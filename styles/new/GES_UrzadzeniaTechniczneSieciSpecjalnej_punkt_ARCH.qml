...
<qgis styleCategories="Symbology|Labeling" version="3.22.4-Białowieża" labelsEnabled="1">
  <renderer-v2 type="RuleRenderer" forceraster="0" enableorderby="0" symbollevels="0" referencescale="-1">
    <rules key="{cb5e162a-3ff2-4870-b3f3-0ea637c516c3}">
      <rule symbol="0" filter=" &quot;rodzajUrzadzenia&quot; = 'u'" scalemindenom="1" scalemaxdenom="1001" label="urządzenie techniczne sieci specjalnej SUSU" key="{3fe958e9-57d8-4822-a896-bb4d3196cb6d}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{e5a07ced-09ea-4c25-afa8-5c2ada06c99f}">
      <rule filter=" IF(&quot;PrezentacjaGraficzna_geometria&quot;, &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True)" scalemindenom="1" scalemaxdenom="1001" key="{b8bdf2ca-8c8d-4280-9051-25dc39628cab}" description="Prezentacja graficzna">
