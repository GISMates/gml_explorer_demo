...
<qgis version="3.22.4-Białowieża" styleCategories="Symbology|Labeling|Actions" labelsEnabled="1">
  <renderer-v2 referencescale="-1" enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{d91e5659-798b-4668-bc08-e5f1232e3ef8}">
      <rule scalemindenom="1" symbol="0" scalemaxdenom="1001" key="{d3ca510d-2908-4a9f-9a6a-0c5f40836a35}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{f8b21d23-caed-484f-95f3-52dc0029243d}">
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="2001" key="{47ef0c14-d5a3-4e8e-b3d9-4770954a79cc}">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="2001" key="{617cbe38-bacf-4eb5-b67e-8cb6d0314f57}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="2001" key="{590063ef-cb2d-477d-bd15-4b3a7c3276c8}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="2001" key="{e427c404-a90e-4449-b9f6-ff671d5027cb}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="2001" key="{6073e5d5-6637-4785-a5db-1d9771eff925}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="2001" key="{30eb2a97-5b8d-4280-ae05-84a8b78d10b6}">
        <settings calloutType="simple">
