...
<qgis labelsEnabled="1" styleCategories="Symbology|Labeling|Actions" version="3.22.12-Białowieża">
  ...
  <labeling type="rule-based">
    <rules key="{59c88ceb-a574-4b04-9301-b5286a62cb15}">
      <rule key="{2b75b1a9-b74a-488d-b11b-7b634fa88c4c}" description="Prezentacja graficzna" scalemindenom="1" filter="IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True), True), True)" scalemaxdenom="1001">
      ...
      <rule key="{f823c54d-b445-4a8d-8438-bad3ee248803}" description="Prezentacja graficzna" scalemindenom="1" filter=" IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True), True), True)" scalemaxdenom="1001">
        <settings calloutType="simple">
      ...
      <rule key="{21d85831-d11c-4b5d-a4ae-a0ac0eaa0251}" description="Prezentacja graficzna" scalemindenom="1" filter=" IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True), True), True)" scalemaxdenom="1001">
        <settings calloutType="simple">
      ...
      <rule key="{a93abed1-3aa3-4ccc-a186-1eec2db2c29d}" description="Prezentacja graficzna" scalemindenom="1" filter=" IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True), True), True)" scalemaxdenom="1001">
        <settings calloutType="simple">
      ...
      <rule key="{3600e9f1-db7c-4f53-b4a8-5c4ed638ea29}" description="Prezentacja graficzna" scalemindenom="1" filter=" IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True), True), True)" scalemaxdenom="1001">
        <settings calloutType="simple">
