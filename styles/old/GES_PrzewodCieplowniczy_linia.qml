...
<qgis version="3.22.4-Białowieża" styleCategories="Symbology|Labeling|Actions" labelsEnabled="1">
  <renderer-v2 referencescale="-1" enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{6189860c-f783-4145-a5f9-c7fbe370881b}">
      <rule symbol="0" filter="IF (@map_scale &lt;= 1000, coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy' AND (&quot;srednica&quot; IS NULL OR &quot;srednica&quot;/1000 &lt;= 0.75), coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy' AND (&quot;przebieg&quot; IS NULL OR &quot;przebieg&quot; IN('naziemny', 'nadziemny')))" key="{17b0aab9-96d7-4a56-8020-c9ebc7055cad}" label="przewód ciepłowniczy SUPC_01"/>
      <rule scalemindenom="1" symbol="1" filter=" coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy' AND &quot;srednica&quot; IS NOT NULL AND &quot;srednica&quot;/1000 > 0.75" scalemaxdenom="1001" key="{4ac38f4e-64a1-49d1-a0f2-91523b56b2e9}" label="przewód ciepłowniczy SUPC_02"/>
      <rule scalemindenom="1" symbol="2" filter="IF (@map_scale &lt;= 500, coalesce(&quot;istnienie&quot;, 'istniejacy') IN ('projektowany', 'wBudowie') AND (&quot;srednica&quot; IS NULL OR &quot;srednica&quot;/1000 &lt;= 0.75), coalesce(&quot;istnienie&quot;, 'istniejacy') IN ('projektowany', 'wBudowie'))" scalemaxdenom="1001" key="{9f838146-e704-4206-aed5-c16033ac42c5}" label="przewód ciepłowniczy - projektowany lub w budowie SUPC_P_01"/>
      <rule scalemindenom="1" symbol="3" filter=" coalesce(&quot;istnienie&quot;, 'istniejacy') IN ('projektowany', 'wBudowie') AND &quot;srednica&quot; IS NOT NULL AND &quot;srednica&quot;/1000 > 0.75" scalemaxdenom="501" key="{665618df-0093-4d15-89e0-f39559bc90ff}" label="przewód ciepłowniczy - projektowany lub w budowie SUPC_P_02"/>
    </rules>
    <symbols>
      <symbol alpha="1" name="0" force_rhr="0" clip_to_extent="1" type="line">
        ...
        <layer locked="0" enabled="1" pass="0" class="SimpleLine">
          <Option type="Map">
            ...
            <Option name="line_color" value="210,0,210,255" type="QString"/>
  ...
  <labeling type="rule-based">
    <rules key="{6ab4fc8d-3540-4c65-9398-16daf0c0bd1d}">
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{eb3bcb96-cbff-4ee3-a743-1e1c530193ba}">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{615b5f1a-95c8-40b3-8681-f1f8db66aa6b}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{ee62fb9e-a872-47fb-872a-b167f7dffbd8}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{599a68b6-0f47-48d3-8113-3f5466fd1a64}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{7f3a07ee-12a2-43cd-8b99-ba3c6b4bded6}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{65827daf-4818-4cb2-a47b-d4cf75a23491}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{9dc12f49-be11-4aed-b57d-3a7ab90cdf22}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{e5eaa870-abc0-47d6-946c-0dcca5c90e77}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{ff676a79-f2b7-44d0-a634-ba829189d6b8}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{b586fe46-40d3-4437-bd66-49978e7236b9}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{f1c59df6-ce1a-4b3a-aa3e-9bcb6f4c37c2}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{6fd472c4-78e4-435f-b38e-84eff78766f4}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{40518405-b982-443a-9b6e-802aee326efe}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{0bef0d8d-eb0f-4d3b-a87a-078acf76f84a}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{e398f8a3-263d-44fc-aa45-b5a2b4e4dd5a}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{56f46f0c-3a85-48e5-88d4-afe6fef54ab8}">
        <settings calloutType="simple">
