...
<qgis version="3.22.4-Białowieża" styleCategories="Symbology|Labeling|Actions" labelsEnabled="1">
  <renderer-v2 referencescale="-1" enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{1641818d-9a33-4e2f-82a7-365fca0e6bec}">
      <rule scalemindenom="1" symbol="0" filter=" &quot;rodzajBloku&quot; = 1" scalemaxdenom="2001" key="{b0f6d4ff-360a-4b46-91b3-00b5f8fc3600}" label="kondygnacje nadziemne EGBC03"/>
      <rule symbol="1" filter=" &quot;rodzajBloku&quot; = 2" key="{5e7a56ba-81f9-4e9f-bd72-9f411250e595}" label="kondygnacje podziemne EGBC04"/>
      <rule scalemindenom="1" symbol="2" filter=" &quot;rodzajBloku&quot; = 3 AND (&quot;numerNajnizszejKondygnacji&quot; >= 0 OR  &quot;numerNajwyzszejKondygnacji&quot; >= 0)" scalemaxdenom="2001" key="{ffc3125c-6109-4a7b-81d3-e6fe525919ec}" label="łącznik nadziemny EGBL05"/>
      <rule scalemindenom="1" symbol="3" filter=" &quot;rodzajBloku&quot; = 3 AND (&quot;numerNajnizszejKondygnacji&quot; &lt; 0 AND  &quot;numerNajwyzszejKondygnacji&quot; &lt; 0)" scalemaxdenom="2001" key="{0a97ba73-360a-45db-a769-30b1290ac1f1}" label="łącznik podziemny EGBL05_01"/>
      <rule scalemindenom="1" symbol="4" filter=" &quot;rodzajBloku&quot; = 4" scalemaxdenom="2001" key="{a4b07902-e028-48ca-8cb6-85dd0ef13dbf}" label="nawis EGBN11"/>
      <rule scalemindenom="1" symbol="5" filter=" &quot;rodzajBloku&quot; = 5" scalemaxdenom="1001" key="{9dc9aba6-7578-4cc8-90e5-b6da1eefec13}" label="przejazd przez budynek EGBP16"/>
      <rule scalemindenom="1" symbol="6" filter=" &quot;rodzajBloku&quot; = 6" scalemaxdenom="1001" key="{02bd2364-ba4c-41f4-860a-56204e1fbea7}" label="inny"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{e6d71cad-26af-43f5-b7be-d84fdc32453b}">
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{061f7645-af4f-4f64-a281-a50bb1707f51}">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{8f8891ae-179d-4d44-9377-8e237b61a1c6}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{1416b59c-c59e-4a96-b9a2-e10cce9d6b36}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{90ced109-45e0-4240-a6a5-cfd916340b9a}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{40ef1b65-85c7-4094-ad1b-d8d09c40e4bc}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{8a24711e-874a-43ef-947d-9be724779d75}">
        <settings calloutType="simple">
