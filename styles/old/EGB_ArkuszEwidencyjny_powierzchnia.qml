...
<qgis version="3.22.4-Białowieża" styleCategories="Symbology|Labeling|Actions" labelsEnabled="1">
  <renderer-v2 referencescale="-1" enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{2f82abc8-f93d-4ee4-aaf0-e3049bdbbf08}">
      <rule symbol="0" key="{a58b072e-7a1f-47f3-a5e7-60dd9939766a}" label="arkusz ewidencyjny EGBA01"/>
    </rules>
    <symbols>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="interval" type="Map">
                  ...
                  <Option name="expression" value="IF(@map_scale &lt;= 500, 1, IF(@map_scale > 500 AND @map_scale &lt;= 1000, 1.4, IF(@map_scale > 1000 AND @map_scale &lt;= 2000, 2.8, 5)))" type="QString"/>
          ...
          <symbol alpha="1" name="@0@0" force_rhr="0" clip_to_extent="1" type="marker">
            ...
            <layer locked="0" enabled="1" pass="0" class="SimpleMarker">
              <Option type="Map">
                ...
                <Option name="color" value="0,128,0,255" type="QString"/>
                ...
                <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
                <Option name="offset_unit" value="MM" type="QString"/>
                <Option name="outline_color" value="0,128,0,255" type="QString"/>
                ...
                <Option type="Map">
                  ...
                  <Option name="properties" type="Map">
                    <Option name="size" type="Map">
                      <Option name="active" value="true" type="bool"/>
                      <Option name="expression" value="IF(@map_scale &lt;= 500, 0.25, IF(@map_scale > 500 AND @map_scale &lt;= 1000, 0.35, IF(@map_scale > 1000 AND @map_scale &lt;= 2000, 0.7, 1)))" type="QString"/>
                      <Option name="type" value="3" type="int"/>
                    </Option>
                  </Option>
                  <Option name="type" value="collection" type="QString"/>
  ...
  <labeling type="rule-based">
    <rules key="{a2c5e122-b510-407d-83a4-860d109ba1a8}">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{69bbd0de-d495-43bc-a3a8-ff1f6e5350db}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{b48dc5f4-796d-494a-a106-5149e4f12d9b}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{700b11ff-dd55-42c4-b819-33c97eb2e622}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{13e20cfa-c1b9-46e7-8099-75f08eb1df05}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{7239e8bf-a2e1-401e-ada2-52b5f84b8702}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{99d94919-6691-4493-8c80-8dcfd30daa86}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{a9b43c11-db78-4a8a-aa03-f19da6fff0f4}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{c0808cbf-6922-4299-bfea-2b150cf459a8}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{38334d3c-2f14-485c-baea-eac2153b0af5}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{069d24ee-d692-4cf4-93ff-3ff21049a3cd}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{5eff1276-c393-4017-8d1f-0bdcdbc042b0}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{930ec6d0-0e75-4c45-91ac-81e7ec1d1735}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{f476a94f-2244-43a2-83f5-612b17afd0ed}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{a54172bd-b471-4edd-88cf-7f87584ca2bc}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{141daa13-d1af-4a48-929d-4ddc9de08a3f}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{120f42d7-8c62-4469-bd61-8218030d88de}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{e6b59e98-35da-4931-86b8-444253ebe6ce}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{514bdb7b-65dc-4e19-a0cf-31c504e77555}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{7964b5c8-2e3d-4ab2-9803-c134532d4649}">
        <settings calloutType="simple">
