...
<qgis version="3.22.4-Białowieża" styleCategories="Symbology|Labeling|Actions" labelsEnabled="0">
  <renderer-v2 symbollevels="0" forceraster="0" enableorderby="0" referencescale="-1" type="RuleRenderer">
    <rules key="{52b1988e-f953-4cdb-b5bb-1e82509f4431}">
      <rule symbol="0" key="{7994299e-8b05-4218-8109-faad492d599e}" label="las iglasty PTTL01" filter=" &quot;rodzajTerLesn&quot; = 'lasIglasty' "/>
      <rule symbol="1" key="{67e469b9-4089-4397-b8b3-033c51133781}" label="las liściasty PTTL02" filter=" &quot;rodzajTerLesn&quot; = 'lasLisciasty' "/>
      <rule symbol="2" key="{e0434be1-32b5-4f35-bdf1-20b679505d0e}" label="las mieszany PTTL03" filter=" &quot;rodzajTerLesn&quot; = 'lasMieszany'"/>
      <rule symbol="3" key="{23cb3240-f758-4f59-a6cc-df69976a8607}" label="zadrzewienie PTTL04" scalemindenom="1" scalemaxdenom="2001" filter=" &quot;rodzajTerLesn&quot; = 'zadrzewienie' "/>
      <rule symbol="4" key="{4a576e5d-a9ee-4d63-9faa-ea5229177088}" label="zakrzewienie PTTL05" scalemindenom="1" scalemaxdenom="1001" filter=" &quot;rodzajTerLesn&quot; = 'zakrzewienie' "/>
    </rules>
    <symbols>
