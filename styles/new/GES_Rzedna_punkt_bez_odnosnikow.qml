...
<qgis styleCategories="Symbology|Labeling|Actions" labelsEnabled="1" version="3.22.12-Białowieża">
  <renderer-v2 symbollevels="0" referencescale="-1" enableorderby="0" type="RuleRenderer" forceraster="0">
    <rules key="{d7f1e78e-d368-4b3c-b57a-4ddc6bebf389}">
      <rule key="{9a97681a-9224-4a03-b98b-edb02ae16e3e}" symbol="0" scalemaxdenom="1001" label="punkt" scalemindenom="1"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{10028984-200b-4172-b731-1676a6fa6b70}">
      <rule filter="IF(&quot;PrezentacjaGraficzna_geometria&quot;, &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True)" key="{3a0768cc-c9e6-464b-967f-a0d83cb46e30}" scalemaxdenom="1001" description="Prezentacja graficzna" scalemindenom="1">
            ...
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                ...
                <Option type="Map" name="Color">
                  <Option type="bool" value="true" name="active"/>
                  <Option type="QString" value="KolorRGB" name="field"/>
