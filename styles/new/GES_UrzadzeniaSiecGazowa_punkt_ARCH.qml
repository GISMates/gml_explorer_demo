...
<qgis styleCategories="Symbology|Labeling" version="3.22.4-Białowieża" labelsEnabled="1">
  <renderer-v2 type="RuleRenderer" forceraster="0" enableorderby="0" symbollevels="0" referencescale="-1">
    <rules key="{3ef8e849-a934-42ce-a5fb-fb3294fef8bc}">
      <rule symbol="0" filter=" &quot;rodzajUrzadzenia&quot; = 'u'" scalemindenom="1" scalemaxdenom="1001" label="gazowe urządzenie techniczne SUGU" key="{74129de9-f301-4bb3-9ce1-c1332d4b1006}"/>
      <rule symbol="1" filter=" &quot;rodzajUrzadzenia&quot; = 'w'" scalemindenom="1" scalemaxdenom="1001" label="zasuwa lub zawór SUGW" key="{e9d36f62-6664-471f-bea0-29426a236fc2}"/>
      <rule symbol="2" filter=" &quot;rodzajUrzadzenia&quot; = 's'" scalemindenom="1" scalemaxdenom="1001" label="szafa gazowa lub kontener SUGS" key="{4f5331f4-5950-452d-9458-2662a96fa9ce}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{4e22a2d8-e620-413c-a491-996f9e75eebf}">
      <rule filter=" IF(&quot;PrezentacjaGraficzna_geometria&quot;, &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True)" scalemindenom="1" scalemaxdenom="1001" key="{32a947c6-391b-46cb-9182-2087556b8848}" description="Prezentacja graficzna">
        <settings calloutType="simple">
          <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontFamily="Arial" namedStyle="Normal" fontWordSpacing="0" isExpression="1" fontLetterSpacing="0" textOrientation="horizontal" multilineHeight="1" allowHtml="0" fieldName="IF(&quot;status&quot; = 'p', 'proj. g', IF( &quot;rodzajUrzadzenia&quot; IN('u', 'w', 's'), 'g', ''))" textColor="125,125,125,255" textOpacity="1" fontSize="0.75" useSubstitutions="0" legendString="Aa" capitalization="0" fontItalic="0" fontKerning="1" fontUnderline="0" blendMode="0" fontSizeUnit="RenderMetersInMapUnits" fontStrikeout="0" fontWeight="50" previewBkgrdColor="255,255,255,255">
            <families/>
