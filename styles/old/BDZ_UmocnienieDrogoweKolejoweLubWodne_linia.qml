...
<qgis version="3.22.4-Białowieża" styleCategories="Symbology|Labeling|Actions" labelsEnabled="1">
  <renderer-v2 symbollevels="0" forceraster="0" enableorderby="0" referencescale="-1" type="RuleRenderer">
    <rules key="{7839b574-16d8-4822-9143-d8c19b48f265}">
      <rule symbol="0" key="{1a502dc6-b25b-4e83-90e6-f9df2ad100b8}" label="ostroga BUUD01_01" scalemindenom="1" scalemaxdenom="1001" filter=" &quot;rodzajUmocn&quot; = 'ostroga'"/>
      <rule symbol="1" key="{47131b67-5bfe-4798-bc8e-11a05f4a82dc}" label="ściana oporowa BUUD02_01" scalemindenom="1" scalemaxdenom="1001" filter=" &quot;rodzajUmocn&quot; = 'scianaOporowa' "/>
    </rules>
    <symbols>
      ...
      <symbol name="1" type="line" alpha="1" force_rhr="0" clip_to_extent="1">
        ...
        <layer class="GeometryGenerator" enabled="1" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option value="IF(@map_scale &lt;= 500, buffer($geometry, 0.25, 5, 'flat', 'miter'), buffer($geometry, 0.5, 5, 'flat', 'miter'))" name="geometryModifier" type="QString"/>
            <Option value="MapUnit" name="units" type="QString"/>
          </Option>
          <prop k="SymbolType" v="Fill"/>
          <prop k="geometryModifier" v="IF(@map_scale &lt;= 500, buffer($geometry, 0.25, 5, 'flat', 'miter'), buffer($geometry, 0.5, 5, 'flat', 'miter'))"/>
          ...
          <symbol name="@1@0" type="fill" alpha="1" force_rhr="0" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
        ...
        <layer class="GeometryGenerator" enabled="1" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option value="IF(@map_scale &lt;= 500, generateRetainingWallGeometryOld(1, 5, buffer($geometry, 0.25, 5, 'flat', 'miter')), generateRetainingWallGeometryOld(1.4, 7, buffer($geometry, 0.35, 5, 'flat', 'miter')))" name="geometryModifier" type="QString"/>
            <Option value="MapUnit" name="units" type="QString"/>
          </Option>
          <prop k="SymbolType" v="Line"/>
          <prop k="geometryModifier" v="IF(@map_scale &lt;= 500, generateRetainingWallGeometryOld(1, 5, buffer($geometry, 0.25, 5, 'flat', 'miter')), generateRetainingWallGeometryOld(1.4, 7, buffer($geometry, 0.35, 5, 'flat', 'miter')))"/>
          <prop k="units" v="MapUnit"/>
          <data_defined_properties>
            <Option type="Map">
              <Option value="" name="name" type="QString"/>
  ...
  <labeling type="rule-based">
    <rules key="{6e554563-44ad-4d27-9fef-c88459004ca1}">
      <rule key="{1c44fc3a-388e-4c13-8885-5cde292052f5}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
      ...
      <rule key="{11d86e15-17fb-4e26-b7de-da9a9d00e4b3}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
      ...
      <rule key="{d7a27e49-4593-40fa-97da-cbf59aa46378}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
      ...
      <rule key="{79b123ab-aa36-479c-9d09-6f059ef64175}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
      ...
      <rule key="{ddb13c11-7996-4f7a-aa65-45838a85bfac}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
      ...
      <rule key="{457be436-725d-45a4-b70b-c60a75e70952}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
      ...
      <rule key="{acfb210a-ed21-4373-9b8c-a506b41b8233}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
          <text-style fontFamily="Arial" fontWordSpacing="0" multilineHeight="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontLetterSpacing="0" namedStyle="Normal" fieldName="string_to_array(  &quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[6]" textOrientation="horizontal" fontWeight="50" blendMode="0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" capitalization="0" fontSize="0.75" textColor="0,0,0,255" isExpression="1" fontItalic="0" legendString="Aa" fontSizeUnit="RenderMetersInMapUnits" allowHtml="0" textOpacity="1" fontUnderline="0" fontKerning="1" useSubstitutions="0">
            <families/>
            <text-buffer bufferColor="255,255,255,255" bufferJoinStyle="128" bufferNoFill="1" bufferOpacity="1" bufferSizeUnits="RenderMetersInMapUnits" bufferBlendMode="0" bufferDraw="1" bufferSize="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0"/>
      ...
      <rule key="{85fd7cc7-6c2d-4da6-bdcb-e3eec057d904}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
          <text-style fontFamily="Arial" fontWordSpacing="0" multilineHeight="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontLetterSpacing="0" namedStyle="Normal" fieldName="string_to_array(  &quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[7]" textOrientation="horizontal" fontWeight="50" blendMode="0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" capitalization="0" fontSize="0.75" textColor="0,0,0,255" isExpression="1" fontItalic="0" legendString="Aa" fontSizeUnit="RenderMetersInMapUnits" allowHtml="0" textOpacity="1" fontUnderline="0" fontKerning="1" useSubstitutions="0">
            <families/>
            <text-buffer bufferColor="255,255,255,255" bufferJoinStyle="128" bufferNoFill="1" bufferOpacity="1" bufferSizeUnits="RenderMetersInMapUnits" bufferBlendMode="0" bufferDraw="1" bufferSize="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0"/>
      ...
      <rule key="{f5b2025c-8264-4e94-934f-f311befde5fb}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
      ...
      <rule key="{2fe19390-4816-4eb8-8511-7233ffe2cb81}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
      ...
      <rule key="{d1557b3e-90f0-4c67-b514-3c919163d9a1}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
      ...
      <rule key="{10d46b0b-4316-430e-9750-bc88eb6de44f}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
      ...
      <rule key="{87433cac-49bf-433f-9ceb-85a894b49963}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
      ...
      <rule key="{12d3d857-ffc2-4a04-9bb1-c4cb8852d50d}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
      ...
      <rule key="{87fed913-bfa1-41a6-b015-4e5858c46838}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
      ...
      <rule key="{af619a92-66bd-4ac0-bd65-c5b8e3338c4c}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
