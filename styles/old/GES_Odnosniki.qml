...
<qgis styleCategories="Symbology|Labeling" version="3.22.12-Białowieża" labelsEnabled="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer" referencescale="-1" enableorderby="0" forceraster="0">
    <rules key="{8d91adb6-b0ab-4e78-94f6-29eae35ef204}">
      <rule scalemindenom="1" symbol="0" scalemaxdenom="1001" label="odnośnik" key="{5300cb2e-8997-4e0d-ac93-b59094f2444e}"/>
    </rules>
    <symbols>
