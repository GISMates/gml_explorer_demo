...
<qgis version="3.22.4-Białowieża" styleCategories="Symbology|Labeling|Actions" labelsEnabled="1">
  <renderer-v2 symbollevels="0" forceraster="0" enableorderby="0" referencescale="-1" type="RuleRenderer">
    <rules key="{7a72a90b-4594-4b81-a9c2-602345ee9e30}">
      <rule symbol="0" key="{ed42590a-43b9-4b45-b80c-b5eae492e2eb}" label="punkt wysokościowy naturalny RTPW01" scalemindenom="1" scalemaxdenom="1001" filter=" &quot;rodzajPunktu&quot; = 'punktWysokosciowyNaturalny' "/>
      <rule symbol="1" key="{fee53719-ac8a-408a-835b-bbc636bc8eff}" label="punkt wysokościowy sztuczny RTPW02" scalemindenom="1" scalemaxdenom="1001" filter=" &quot;rodzajPunktu&quot; = 'punktWysokosciowySztuczny' "/>
    </rules>
    <symbols>
      <symbol name="0" type="marker" alpha="1" force_rhr="0" clip_to_extent="1">
        ...
        <layer class="GeometryGenerator" enabled="1" locked="0" pass="0">
          ...
          <symbol name="@0@0" type="line" alpha="1" force_rhr="0" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
    ...
    <rules key="{de458331-fd67-46ea-b2b7-198fc194b12d}">
      <rule key="{def00b0a-e346-48ef-ab7e-3185fd031804}" scalemindenom="1" scalemaxdenom="1001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
          ...
          <placement xOffset="0" maxCurvedCharAngleOut="-25" layerType="PointGeometry" overrunDistance="0" distUnits="MM" placement="1" rotationAngle="0" quadOffset="8" maxCurvedCharAngleIn="25" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0" geometryGeneratorEnabled="1" centroidInside="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" lineAnchorPercent="0.5" distMapUnitScale="3x:0,0,0,0,0,0" rotationUnit="AngleDegrees" geometryGeneratorType="PointGeometry" lineAnchorType="0" centroidWhole="0" placementFlags="10" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" offsetType="0" offsetUnits="MM" fitInPolygonOnly="0" preserveRotation="1" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" priority="10" overrunDistanceUnit="MM" dist="0" polygonPlacementFlags="2" yOffset="0" geometryGenerator=" geom_from_wkt(string_to_array(  &quot;KR_ObiektKarto_geometriaKarto&quot; , ', ')[0])"/>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                ...
                <Option name="OffsetQuad" type="Map">
                  <Option value="true" name="active" type="bool"/>
                  <Option value="&quot;KR_ObiektKarto_etykieta_KREtykieta_justyfikacja&quot; + 1" name="expression" type="QString"/>
                  <Option value="3" name="type" type="int"/>
                </Option>
                <Option name="Size" type="Map">
                  <Option value="true" name="active" type="bool"/>
