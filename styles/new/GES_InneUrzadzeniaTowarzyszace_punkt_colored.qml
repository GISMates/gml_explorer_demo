...
<qgis styleCategories="Symbology|Labeling|Actions" version="3.22.12-Białowieża" labelsEnabled="1">
  <renderer-v2 enableorderby="0" type="RuleRenderer" symbollevels="0" forceraster="0" referencescale="-1">
    <rules key="{71654b89-882d-4ad6-a74d-9e103f588c65}">
      <rule label="właz do komory lub kanału SUPW_O" scalemindenom="1" filter=" &quot;rodzajUrzadzenia&quot; = 'w' AND coalesce(&quot;ksztaltUrzadzenia&quot;, '') = 'o'" key="{5d11a5ba-045f-43e7-9e61-4fe97ab40367}" scalemaxdenom="1001" symbol="0"/>
      <rule label="właz do komory lub kanału SUPW_K" scalemindenom="1" filter=" &quot;rodzajUrzadzenia&quot; = 'w' AND coalesce(&quot;ksztaltUrzadzenia&quot;, '') = 'k'" key="{5d11a5ba-045f-43e7-9e61-4fe97ab40367}" scalemaxdenom="1001" symbol="1"/>
      ...
      <rule label="komora podziemna SUPK" filter=" &quot;rodzajUrzadzenia&quot; = 'k'" key="{3cf25c37-66f7-42a6-8be0-09126d1fe5b3}" symbol="6"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{64bc0298-93ea-41cf-91ff-104081293938}">
      <rule scalemindenom="1" filter=" IF(&quot;PrezentacjaGraficzna_geometria&quot;, &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True)" key="{f0344709-2dce-494a-95e7-6be3dbbb5d56}" scalemaxdenom="1001" description="Prezentacja graficzna">
        <settings calloutType="simple">
          <text-style allowHtml="0" fontItalic="0" previewBkgrdColor="255,255,255,255" fontWordSpacing="0" fontSize="0.75" multilineHeight="1" fontStrikeout="0" fontSizeUnit="RenderMetersInMapUnits" capitalization="0" isExpression="1" fontLetterSpacing="0" fieldName="IF(&quot;status&quot; = 'p', concat('proj. ',  &quot;rodzajSieci&quot;), IF( &quot;rodzajUrzadzenia&quot; = 'w',  &quot;rodzajSieci&quot;, ''))" legendString="Aa" textColor="85,170,255,255" fontUnderline="0" useSubstitutions="0" fontKerning="1" fontWeight="50" blendMode="0" fontFamily="Arial" textOpacity="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Normal" textOrientation="horizontal">
            <families/>
