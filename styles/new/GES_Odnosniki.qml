...
<qgis version="3.22.12-Białowieża" styleCategories="Symbology|Labeling" labelsEnabled="0">
  <renderer-v2 enableorderby="0" symbollevels="0" referencescale="-1" type="RuleRenderer" forceraster="0">
    <rules key="{784b87e3-29ac-4e95-8d8e-cb6cf013878d}">
      <rule scalemaxdenom="501" symbol="0" key="{c1369881-3fc0-4c78-aec9-1427a1f496db}" scalemindenom="1" label="odnośnik"/>
    </rules>
    <symbols>
