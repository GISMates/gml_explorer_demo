...
<qgis version="3.22.12-Białowieża" styleCategories="Symbology|Labeling|Actions" labelsEnabled="1">
  ...
  <labeling type="rule-based">
    <rules key="{ad4fcbb9-2be7-45a9-b36e-f49d050a1d53}">
      <rule filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" key="{ae3495a8-7364-4c49-a407-234b5af2c325}" description="KR_Etykieta" scalemindenom="1" scalemaxdenom="5001">
        <settings calloutType="simple">
          <text-style allowHtml="0" textOrientation="horizontal" fieldName="IF(string_to_array(&quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[0] IS NULL, regexp_replace( &quot;idPunktu&quot; , '(.*)\\.(.*)$', '\\2'), string_to_array(&quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[0])" fontLetterSpacing="0" useSubstitutions="0" multilineHeight="1" namedStyle="Normal" capitalization="0" previewBkgrdColor="255,255,255,255" textOpacity="1" fontStrikeout="0" fontFamily="Arial" fontKerning="1" fontUnderline="0" textColor="0,128,0,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSize="0.75" isExpression="1" blendMode="0" fontWordSpacing="0" fontWeight="50" fontSizeUnit="RenderMetersInMapUnits" legendString="Aa" fontItalic="0">
            <families/>
            ...
            <shadow shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowOffsetGlobal="1" shadowOffsetAngle="135" shadowScale="100" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowUnder="0" shadowOffsetUnit="MM" shadowColor="0,0,0,255" shadowBlendMode="6" shadowRadius="1.5" shadowOpacity="0.69999999999999996" shadowRadiusAlphaOnly="0" shadowOffsetDist="1" shadowRadiusUnit="MM" shadowDraw="0"/>
            <dd_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
