...
<qgis version="3.22.4-Białowieża" styleCategories="Symbology|Labeling|Actions" labelsEnabled="0">
  <renderer-v2 symbollevels="0" forceraster="0" enableorderby="0" referencescale="-1" type="RuleRenderer">
    <rules key="{ff46dbf3-4d20-4629-bc0c-4502c6e17daf}">
      <rule symbol="0" key="{089e6006-e767-4b2d-8a10-3de727fce874}" label="ogrodzenie trwałe KTOK05_0x" filter=" &quot;rodzajObKomun&quot; = 'ogrodzenieTrwale' "/>
      <rule symbol="1" key="{2f66f089-dcce-4ce5-979c-fba52be4ab90}" label="schody w ciągu komunikacyjnym KTOK06" scalemindenom="1" scalemaxdenom="1001" filter=" &quot;rodzajObKomun&quot; = 'schodyWCiaguKomunikacyjnym'"/>
    </rules>
    <symbols>
          ...
          <symbol name="@0@1" type="line" alpha="1" force_rhr="0" clip_to_extent="1">
            ...
            <layer class="MarkerLine" enabled="1" locked="0" pass="0">
              <Option type="Map">
                ...
                <Option value="16" name="interval" type="QString"/>
                ...
                <Option type="Map">
                  ...
                  <Option name="properties" type="Map">
                    <Option name="interval" type="Map">
                      <Option value="true" name="active" type="bool"/>
                      <Option value="IF(@map_scale &lt; 5000, 16, 25)" name="expression" type="QString"/>
                      <Option value="3" name="type" type="int"/>
                    </Option>
                  </Option>
                  <Option value="collection" name="type" type="QString"/>
              ...
              <symbol name="@@0@1@0" type="marker" alpha="1" force_rhr="0" clip_to_extent="1">
                <data_defined_properties>
                  <Option type="Map">
                    <Option value="" name="name" type="QString"/>
                    <Option name="properties"/>
                    ...
                    <Option type="Map">
                      ...
                      <Option name="properties" type="Map">
                        <Option name="size" type="Map">
                          <Option value="true" name="active" type="bool"/>
                          <Option value="IF(@map_scale &lt; 5000, 1, 2)" name="expression" type="QString"/>
                          <Option value="3" name="type" type="int"/>
                        </Option>
                      </Option>
                      <Option value="collection" name="type" type="QString"/>
              ...
              <data_defined_properties>
                <Option type="Map">
                  ...
                  <Option name="properties" type="Map">
                    <Option name="outlineWidth" type="Map">
                      <Option value="true" name="active" type="bool"/>
                      <Option value="IF(@map_scale &lt; 5000, 0.5, 0.9)" name="expression" type="QString"/>
                      <Option value="3" name="type" type="int"/>
                    </Option>
                  </Option>
                  <Option value="collection" name="type" type="QString"/>
      ...
      <symbol name="1" type="fill" alpha="1" force_rhr="0" clip_to_extent="1">
        ...
        <layer class="GeometryGenerator" enabled="1" locked="0" pass="0">
          <Option type="Map">
            <Option value="Line" name="SymbolType" type="QString"/>
            <Option value="IF(&quot;KR_ObiektKarto_geometriaKarto&quot; IS NULL,  generateStairsFillGeometry(), geom_from_wkt(&quot;KR_ObiektKarto_geometriaKarto&quot;))" name="geometryModifier" type="QString"/>
            <Option value="MapUnit" name="units" type="QString"/>
          </Option>
          <prop k="SymbolType" v="Line"/>
          <prop k="geometryModifier" v="IF(&quot;KR_ObiektKarto_geometriaKarto&quot; IS NULL,  generateStairsFillGeometry(), geom_from_wkt(&quot;KR_ObiektKarto_geometriaKarto&quot;))"/>
          <prop k="units" v="MapUnit"/>
          <data_defined_properties>
            <Option type="Map">
              <Option value="" name="name" type="QString"/>
