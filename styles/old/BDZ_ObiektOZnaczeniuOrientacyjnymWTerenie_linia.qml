...
<qgis version="3.22.4-Białowieża" styleCategories="Symbology|Labeling|Actions" labelsEnabled="1">
  <renderer-v2 symbollevels="0" forceraster="0" enableorderby="0" referencescale="-1" type="RuleRenderer">
    <rules key="{db591232-4409-45be-9f60-7cc1a8ca966c}">
      <rule symbol="0" key="{b8cf71a4-1863-41b9-ba6a-d9e3b4c889fd}" label="mur historyczny OBOO03_02" filter=" &quot;rodzajObOrient&quot; = 'murHistoryczny'"/>
      <rule symbol="1" key="{0cacef7a-57c7-46ed-b627-e21c992e16a2}" label="inny obiekt orientacyjny OBOO08_02" scalemindenom="1" scalemaxdenom="1001" filter=" &quot;rodzajObOrient&quot; = 'inny' "/>
    </rules>
    <symbols>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="outlineWidth" type="Map">
                  ...
                  <Option value="0.961538*(IF(@map_scale &lt;= 500, 0.25, IF(@map_scale > 500 AND @map_scale &lt;= 1000, 0.5, IF(@map_scale > 1000 AND @map_scale &lt;= 2000, 1, 3.5))))" name="expression" type="QString"/>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="interval" type="Map">
                  <Option value="true" name="active" type="bool"/>
                  <Option value="IF(@map_scale &lt;= 500, 3, IF(@map_scale > 500 AND @map_scale &lt;= 1000, 6, IF(@map_scale > 1000 AND @map_scale &lt;= 2000, 12, 28.5)))" name="expression" type="QString"/>
                  <Option value="3" name="type" type="int"/>
                </Option>
              </Option>
              <Option value="collection" name="type" type="QString"/>
                ...
                <Option type="Map">
                  ...
                  <Option name="properties" type="Map">
                    <Option name="offset" type="Map">
                      <Option value="true" name="active" type="bool"/>
                      <Option value="IF(@map_scale &lt;= 500, '0,0.125', IF(@map_scale > 500 AND @map_scale &lt;= 1000, '0,0.25', IF(@map_scale > 1000 AND @map_scale &lt;= 2000, '0,0.5', '0,1.75')))" name="expression" type="QString"/>
                      <Option value="3" name="type" type="int"/>
                    </Option>
                    <Option name="size" type="Map">
                      <Option value="true" name="active" type="bool"/>
                      <Option value="IF(@map_scale &lt;= 500, 0.5, IF(@map_scale > 500 AND @map_scale &lt;= 1000, 1, IF(@map_scale > 1000 AND @map_scale &lt;= 2000, 2, 7)))" name="expression" type="QString"/>
                      <Option value="3" name="type" type="int"/>
                    </Option>
                  </Option>
                  <Option value="collection" name="type" type="QString"/>
  ...
  <labeling type="rule-based">
    <rules key="{9503d7c9-2074-4fc3-979a-fb3faec94f7a}">
      <rule key="{a111a14a-e169-4d09-ae84-3194e23b9bec}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
      ...
      <rule key="{b0d73d1e-5e05-40ca-ac15-5e33752bf4b0}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
      ...
      <rule key="{0fd041ad-df6d-40f6-8fd5-0db6bcd7b089}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
      ...
      <rule key="{3fd361b0-3b67-4db0-b707-b1e6463a1130}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
      ...
      <rule key="{8cd2930e-2891-4ed2-8129-7d2acae91abd}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
      ...
      <rule key="{321e9966-c39c-4d1e-82c1-ee091bc1a5e4}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
      ...
      <rule key="{538fa906-637b-4dff-8d85-723e7ff94946}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
          <text-style fontFamily="Arial" fontWordSpacing="0" multilineHeight="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontLetterSpacing="0" namedStyle="Normal" fieldName="string_to_array(  &quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[6]" textOrientation="horizontal" fontWeight="50" blendMode="0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" capitalization="0" fontSize="0.75" textColor="0,0,0,255" isExpression="1" fontItalic="0" legendString="Aa" fontSizeUnit="RenderMetersInMapUnits" allowHtml="0" textOpacity="1" fontUnderline="0" fontKerning="1" useSubstitutions="0">
            <families/>
            <text-buffer bufferColor="255,255,255,255" bufferJoinStyle="128" bufferNoFill="1" bufferOpacity="1" bufferSizeUnits="RenderMetersInMapUnits" bufferBlendMode="0" bufferDraw="1" bufferSize="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0"/>
      ...
      <rule key="{1782627f-018a-4ac2-903b-3956d18b504b}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
          <text-style fontFamily="Arial" fontWordSpacing="0" multilineHeight="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontLetterSpacing="0" namedStyle="Normal" fieldName="string_to_array(  &quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[7]" textOrientation="horizontal" fontWeight="50" blendMode="0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" capitalization="0" fontSize="0.75" textColor="0,0,0,255" isExpression="1" fontItalic="0" legendString="Aa" fontSizeUnit="RenderMetersInMapUnits" allowHtml="0" textOpacity="1" fontUnderline="0" fontKerning="1" useSubstitutions="0">
            <families/>
            <text-buffer bufferColor="255,255,255,255" bufferJoinStyle="128" bufferNoFill="1" bufferOpacity="1" bufferSizeUnits="RenderMetersInMapUnits" bufferBlendMode="0" bufferDraw="1" bufferSize="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0"/>
      ...
      <rule key="{3e639ec1-46d6-431a-889b-ccd2fa3f2696}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
      ...
      <rule key="{9d4ed792-0e8a-4fed-a959-631116a7453f}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
      ...
      <rule key="{db7c8086-2390-47d1-9a2e-21de67910163}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
      ...
      <rule key="{f5be094d-6720-4880-b860-649e58c5ea82}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
      ...
      <rule key="{1e7550d4-b891-41bd-803c-f2a3d94d1eaa}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
      ...
      <rule key="{37dafefe-bab1-4302-ac29-05ca38716637}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
      ...
      <rule key="{8a7c4692-7a89-44ab-81f0-a2effde19ec6}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
      ...
      <rule key="{36041cba-cc9f-475a-9d87-746cb7b8f7f1}" scalemindenom="1" scalemaxdenom="5001" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" description="KR_Etykieta">
        <settings calloutType="simple">
