...
<qgis labelsEnabled="1" styleCategories="Symbology|Labeling|Actions" version="3.22.12-Białowieża">
  <renderer-v2 enableorderby="0" type="RuleRenderer" forceraster="0" symbollevels="0" referencescale="-1">
    <rules key="{d7f1e78e-d368-4b3c-b57a-4ddc6bebf389}">
      <rule key="{9a97681a-9224-4a03-b98b-edb02ae16e3e}" scalemindenom="1" label="punkt" scalemaxdenom="1001" symbol="0"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{4a156743-3f6c-42d3-8db9-22d1da5682a4}">
      <rule key="{58672358-a4a2-4540-905e-7eb38aa70da7}" description="Prezentacja graficzna" scalemindenom="1" filter="IF(&quot;PrezentacjaGraficzna_geometria&quot;, &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True)" scalemaxdenom="1001">
