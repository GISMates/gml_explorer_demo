...
<qgis version="3.22.4-Białowieża" styleCategories="Symbology|Labeling|Actions" labelsEnabled="1">
  <renderer-v2 referencescale="-1" enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{5a71896f-dbb8-4a5c-95c6-b2ed99ce03fa}">
      <rule symbol="0" filter=" &quot;statusBudynku&quot; IN (1, 3) AND (&quot;liczbaKondygnacjiNadziemnych&quot; > 0 OR (&quot;liczbaKondygnacjiNadziemnych&quot; IS NULL AND (&quot;liczbaKondygnacjiPodziemnych&quot; = 0 OR &quot;liczbaKondygnacjiPodziemnych&quot; IS NULL)))" key="{63f3a076-15f8-472c-9072-e09bd67ff6f5}" label="budynek nadziemny EGBB01"/>
      <rule symbol="1" filter=" &quot;statusBudynku&quot; IN (1, 3) AND (&quot;liczbaKondygnacjiPodziemnych&quot; > 0 AND &quot;liczbaKondygnacjiNadziemnych&quot; = 0)" key="{7275aa22-c987-456d-b40b-fb1a7ee63ede}" label="budynek podziemny EGBB01_01"/>
      <rule symbol="2" filter=" &quot;statusBudynku&quot; = 4" key="{24ee265c-c8d3-422f-bff0-b5f9daf6fffd}" label="budynek projektowany EGBB02"/>
      <rule symbol="3" filter=" &quot;statusBudynku&quot; = 2" key="{d9703906-cbbb-494f-aaba-2353d6139488}" label="budynek w budowie EGBB03"/>
    </rules>
    <symbols>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="outlineWidth" type="Map">
                  ...
                  <Option name="expression" value="IF( @map_scale &lt;= 500, 0.25, IF( @map_scale > 500 AND  @map_scale &lt;= 1000, 0.35, IF(@map_scale > 1000 AND @map_scale &lt;= 2000, 0.7, 1.25)))" type="QString"/>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="customDash" type="Map">
                  <Option name="active" value="true" type="bool"/>
                  <Option name="expression" value="IF( @map_scale &lt;= 500, '1;0.5', IF(@map_scale > 500 AND @map_scale &lt;= 1000, '2;1', IF(@map_scale > 1000 AND @map_scale &lt;= 2000, '3;2', '7.5;5')))" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
                <Option name="outlineWidth" type="Map">
                  <Option name="active" value="true" type="bool"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="customDash" type="Map">
                  <Option name="active" value="true" type="bool"/>
                  <Option name="expression" value="IF( @map_scale &lt;= 500, '1;0.5', IF(@map_scale > 500 AND @map_scale &lt;= 1000, '2;1', IF(@map_scale > 1000 AND @map_scale &lt;= 2000, '2.8;1.4', '7;3.5')))" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
                <Option name="outlineWidth" type="Map">
                  <Option name="active" value="true" type="bool"/>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                ...
                <Option name="offset" type="Map">
                  <Option name="active" value="true" type="bool"/>
                  <Option name="expression" value="IF( @map_scale &lt;= 500, 0.5, IF(@map_scale > 500 AND @map_scale &lt;= 1000, 1, IF(@map_scale > 1000 AND @map_scale &lt;= 2000, 1.4, 3.5)))" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
                <Option name="outlineWidth" type="Map">
                  <Option name="active" value="true" type="bool"/>
  ...
  <labeling type="rule-based">
    <rules key="{2e26c831-4e7b-4a09-b064-1ba4bd32906c}">
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{136ae64f-5345-40e6-9de6-f23a42e46fa9}">
        <settings calloutType="simple">
          <text-style fontSizeUnit="RenderMetersInMapUnits" fieldName="IF(string_to_array(&quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[0] IS NULL, IF( &quot;statusBudynku&quot; = 1 AND (&quot;liczbaKondygnacjiNadziemnych&quot; > 0 OR (&quot;liczbaKondygnacjiNadziemnych&quot; IS NULL AND (&quot;liczbaKondygnacjiPodziemnych&quot; = 0 OR &quot;liczbaKondygnacjiPodziemnych&quot; IS NULL))), IF( @map_scale &lt;= 1000, concat( &quot;glownaFunkcjaBudynku&quot; , ' ',  &quot;liczbaKondygnacjiNadziemnych&quot;, ' ', regexp_replace( &quot;idBudynku&quot;, '(.*)\\.(.*)_BUD$', '\\2')), IF( @map_scale > 1000 AND  @map_scale &lt;= 2000, regexp_replace( &quot;idBudynku&quot;, '(.*)\\.(.*)_BUD$', ' \\2'), '')), IF(&quot;statusBudynku&quot; = 1 AND (&quot;liczbaKondygnacjiPodziemnych&quot; > 0 AND &quot;liczbaKondygnacjiNadziemnych&quot; = 0), IF( @map_scale &lt;= 1000, concat( &quot;glownaFunkcjaBudynku&quot; , ' -',  &quot;liczbaKondygnacjiPodziemnych&quot;, ' ', regexp_replace( &quot;idBudynku&quot;, '(.*)\\.(.*)_BUD$', '\\2') ), IF( @map_scale > 1000 AND  @map_scale &lt;= 2000, regexp_replace( &quot;idBudynku&quot;, '(.*)\\.(.*)_BUD$', ' \\2'), '')), '')), string_to_array(&quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[0])" textColor="10,9,9,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" legendString="Aa" isExpression="1" multilineHeight="1" fontUnderline="0" fontWeight="50" fontKerning="1" textOpacity="1" previewBkgrdColor="255,255,255,255" fontStrikeout="0" fontLetterSpacing="0" textOrientation="horizontal" fontWordSpacing="0" fontFamily="Arial" blendMode="0" namedStyle="Normal" allowHtml="0" capitalization="0" fontItalic="0" fontSize="1.25">
            <families/>
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{761e4fee-1968-4e8c-b413-170780e6e2f8}">
        <settings calloutType="simple">
          <text-style fontSizeUnit="RenderMetersInMapUnits" fieldName="IF(string_to_array(&quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[1] IS NULL, IF( &quot;statusBudynku&quot; = 1 AND (&quot;liczbaKondygnacjiNadziemnych&quot; > 0 OR (&quot;liczbaKondygnacjiNadziemnych&quot; IS NULL AND (&quot;liczbaKondygnacjiPodziemnych&quot; = 0 OR &quot;liczbaKondygnacjiPodziemnych&quot; IS NULL))), IF( @map_scale &lt;= 1000, concat( &quot;glownaFunkcjaBudynku&quot; , ' ',  &quot;liczbaKondygnacjiNadziemnych&quot;, ' ', regexp_replace( &quot;idBudynku&quot;, '(.*)\\.(.*)_BUD$', '\\2')), IF( @map_scale > 1000 AND  @map_scale &lt;= 2000, regexp_replace( &quot;idBudynku&quot;, '(.*)\\.(.*)_BUD$', ' \\2'), '')), IF(&quot;statusBudynku&quot; = 1 AND (&quot;liczbaKondygnacjiPodziemnych&quot; > 0 AND &quot;liczbaKondygnacjiNadziemnych&quot; = 0), IF( @map_scale &lt;= 1000, concat( &quot;glownaFunkcjaBudynku&quot; , ' -',  &quot;liczbaKondygnacjiPodziemnych&quot;, ' ', regexp_replace( &quot;idBudynku&quot;, '(.*)\\.(.*)_BUD$', '\\2') ), IF( @map_scale > 1000 AND  @map_scale &lt;= 2000, regexp_replace( &quot;idBudynku&quot;, '(.*)\\.(.*)_BUD$', ' \\2'), '')), '')), string_to_array(&quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[1])" textColor="10,9,9,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" legendString="Aa" isExpression="1" multilineHeight="1" fontUnderline="0" fontWeight="50" fontKerning="1" textOpacity="1" previewBkgrdColor="255,255,255,255" fontStrikeout="0" fontLetterSpacing="0" textOrientation="horizontal" fontWordSpacing="0" fontFamily="Arial" blendMode="0" namedStyle="Normal" allowHtml="0" capitalization="0" fontItalic="0" fontSize="1.25">
            <families/>
            <text-buffer bufferOpacity="1" bufferDraw="1" bufferColor="255,255,255,255" bufferBlendMode="0" bufferJoinStyle="128" bufferSize="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="RenderMetersInMapUnits" bufferNoFill="1"/>
            <text-mask maskOpacity="1" maskedSymbolLayers="" maskSizeUnits="MM" maskEnabled="0" maskJoinStyle="128" maskSize="1.5" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
            <background shapeRadiiY="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeJoinStyle="64" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOpacity="1" shapeRotation="0" shapeRadiiUnit="MM" shapeRotationType="0" shapeOffsetUnit="MM" shapeType="0" shapeSizeUnit="MM" shapeSVGFile="" shapeFillColor="255,255,255,255" shapeSizeY="0" shapeDraw="0" shapeSizeX="0" shapeBorderWidthUnit="MM" shapeOffsetX="0" shapeOffsetY="0" shapeRadiiX="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidth="0" shapeBorderColor="128,128,128,255">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{c92fcea2-7809-4a74-924d-bdd0727f10cf}">
        <settings calloutType="simple">
          <text-style fontSizeUnit="RenderMetersInMapUnits" fieldName="IF(string_to_array(&quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[2] IS NULL, IF( &quot;statusBudynku&quot; = 1 AND (&quot;liczbaKondygnacjiNadziemnych&quot; > 0 OR (&quot;liczbaKondygnacjiNadziemnych&quot; IS NULL AND (&quot;liczbaKondygnacjiPodziemnych&quot; = 0 OR &quot;liczbaKondygnacjiPodziemnych&quot; IS NULL))), IF( @map_scale &lt;= 1000, concat( &quot;glownaFunkcjaBudynku&quot; , ' ',  &quot;liczbaKondygnacjiNadziemnych&quot;, ' ', regexp_replace( &quot;idBudynku&quot;, '(.*)\\.(.*)_BUD$', '\\2')), IF( @map_scale > 1000 AND  @map_scale &lt;= 2000, regexp_replace( &quot;idBudynku&quot;, '(.*)\\.(.*)_BUD$', ' \\2'), '')), IF(&quot;statusBudynku&quot; = 1 AND (&quot;liczbaKondygnacjiPodziemnych&quot; > 0 AND &quot;liczbaKondygnacjiNadziemnych&quot; = 0), IF( @map_scale &lt;= 1000, concat( &quot;glownaFunkcjaBudynku&quot; , ' -',  &quot;liczbaKondygnacjiPodziemnych&quot;, ' ', regexp_replace( &quot;idBudynku&quot;, '(.*)\\.(.*)_BUD$', '\\2') ), IF( @map_scale > 1000 AND  @map_scale &lt;= 2000, regexp_replace( &quot;idBudynku&quot;, '(.*)\\.(.*)_BUD$', ' \\2'), '')), '')), string_to_array(&quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[2])" textColor="10,9,9,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" legendString="Aa" isExpression="1" multilineHeight="1" fontUnderline="0" fontWeight="50" fontKerning="1" textOpacity="1" previewBkgrdColor="255,255,255,255" fontStrikeout="0" fontLetterSpacing="0" textOrientation="horizontal" fontWordSpacing="0" fontFamily="Arial" blendMode="0" namedStyle="Normal" allowHtml="0" capitalization="0" fontItalic="0" fontSize="1.25">
            <families/>
            <text-buffer bufferOpacity="1" bufferDraw="1" bufferColor="255,255,255,255" bufferBlendMode="0" bufferJoinStyle="128" bufferSize="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="RenderMetersInMapUnits" bufferNoFill="1"/>
            <text-mask maskOpacity="1" maskedSymbolLayers="" maskSizeUnits="MM" maskEnabled="0" maskJoinStyle="128" maskSize="1.5" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
            <background shapeRadiiY="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeJoinStyle="64" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOpacity="1" shapeRotation="0" shapeRadiiUnit="MM" shapeRotationType="0" shapeOffsetUnit="MM" shapeType="0" shapeSizeUnit="MM" shapeSVGFile="" shapeFillColor="255,255,255,255" shapeSizeY="0" shapeDraw="0" shapeSizeX="0" shapeBorderWidthUnit="MM" shapeOffsetX="0" shapeOffsetY="0" shapeRadiiX="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidth="0" shapeBorderColor="128,128,128,255">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{6fbda135-2a5d-485b-a8ac-d3c107518e19}">
        <settings calloutType="simple">
          <text-style fontSizeUnit="RenderMetersInMapUnits" fieldName="IF(string_to_array(&quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[3] IS NULL, IF( &quot;statusBudynku&quot; = 1 AND (&quot;liczbaKondygnacjiNadziemnych&quot; > 0 OR (&quot;liczbaKondygnacjiNadziemnych&quot; IS NULL AND (&quot;liczbaKondygnacjiPodziemnych&quot; = 0 OR &quot;liczbaKondygnacjiPodziemnych&quot; IS NULL))), IF( @map_scale &lt;= 1000, concat( &quot;glownaFunkcjaBudynku&quot; , ' ',  &quot;liczbaKondygnacjiNadziemnych&quot;, ' ', regexp_replace( &quot;idBudynku&quot;, '(.*)\\.(.*)_BUD$', '\\2')), IF( @map_scale > 1000 AND  @map_scale &lt;= 2000, regexp_replace( &quot;idBudynku&quot;, '(.*)\\.(.*)_BUD$', ' \\2'), '')), IF(&quot;statusBudynku&quot; = 1 AND (&quot;liczbaKondygnacjiPodziemnych&quot; > 0 AND &quot;liczbaKondygnacjiNadziemnych&quot; = 0), IF( @map_scale &lt;= 1000, concat( &quot;glownaFunkcjaBudynku&quot; , ' -',  &quot;liczbaKondygnacjiPodziemnych&quot;, ' ', regexp_replace( &quot;idBudynku&quot;, '(.*)\\.(.*)_BUD$', '\\2') ), IF( @map_scale > 1000 AND  @map_scale &lt;= 2000, regexp_replace( &quot;idBudynku&quot;, '(.*)\\.(.*)_BUD$', ' \\2'), '')), '')), string_to_array(&quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[3])" textColor="10,9,9,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" legendString="Aa" isExpression="1" multilineHeight="1" fontUnderline="0" fontWeight="50" fontKerning="1" textOpacity="1" previewBkgrdColor="255,255,255,255" fontStrikeout="0" fontLetterSpacing="0" textOrientation="horizontal" fontWordSpacing="0" fontFamily="Arial" blendMode="0" namedStyle="Normal" allowHtml="0" capitalization="0" fontItalic="0" fontSize="1.25">
            <families/>
            <text-buffer bufferOpacity="1" bufferDraw="1" bufferColor="255,255,255,255" bufferBlendMode="0" bufferJoinStyle="128" bufferSize="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="RenderMetersInMapUnits" bufferNoFill="1"/>
            <text-mask maskOpacity="1" maskedSymbolLayers="" maskSizeUnits="MM" maskEnabled="0" maskJoinStyle="128" maskSize="1.5" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
            <background shapeRadiiY="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeJoinStyle="64" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOpacity="1" shapeRotation="0" shapeRadiiUnit="MM" shapeRotationType="0" shapeOffsetUnit="MM" shapeType="0" shapeSizeUnit="MM" shapeSVGFile="" shapeFillColor="255,255,255,255" shapeSizeY="0" shapeDraw="0" shapeSizeX="0" shapeBorderWidthUnit="MM" shapeOffsetX="0" shapeOffsetY="0" shapeRadiiX="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidth="0" shapeBorderColor="128,128,128,255">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{82735a71-7123-4d9d-a594-fe977294db87}">
        <settings calloutType="simple">
          <text-style fontSizeUnit="RenderMetersInMapUnits" fieldName="IF(string_to_array(&quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[4] IS NULL, IF( &quot;statusBudynku&quot; = 1 AND (&quot;liczbaKondygnacjiNadziemnych&quot; > 0 OR (&quot;liczbaKondygnacjiNadziemnych&quot; IS NULL AND (&quot;liczbaKondygnacjiPodziemnych&quot; = 0 OR &quot;liczbaKondygnacjiPodziemnych&quot; IS NULL))), IF( @map_scale &lt;= 1000, concat( &quot;glownaFunkcjaBudynku&quot; , ' ',  &quot;liczbaKondygnacjiNadziemnych&quot;, ' ', regexp_replace( &quot;idBudynku&quot;, '(.*)\\.(.*)_BUD$', '\\2')), IF( @map_scale > 1000 AND  @map_scale &lt;= 2000, regexp_replace( &quot;idBudynku&quot;, '(.*)\\.(.*)_BUD$', ' \\2'), '')), IF(&quot;statusBudynku&quot; = 1 AND (&quot;liczbaKondygnacjiPodziemnych&quot; > 0 AND &quot;liczbaKondygnacjiNadziemnych&quot; = 0), IF( @map_scale &lt;= 1000, concat( &quot;glownaFunkcjaBudynku&quot; , ' -',  &quot;liczbaKondygnacjiPodziemnych&quot;, ' ', regexp_replace( &quot;idBudynku&quot;, '(.*)\\.(.*)_BUD$', '\\2') ), IF( @map_scale > 1000 AND  @map_scale &lt;= 2000, regexp_replace( &quot;idBudynku&quot;, '(.*)\\.(.*)_BUD$', ' \\2'), '')), '')), string_to_array(&quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[4])" textColor="10,9,9,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" legendString="Aa" isExpression="1" multilineHeight="1" fontUnderline="0" fontWeight="50" fontKerning="1" textOpacity="1" previewBkgrdColor="255,255,255,255" fontStrikeout="0" fontLetterSpacing="0" textOrientation="horizontal" fontWordSpacing="0" fontFamily="Arial" blendMode="0" namedStyle="Normal" allowHtml="0" capitalization="0" fontItalic="0" fontSize="1.25">
            <families/>
            <text-buffer bufferOpacity="1" bufferDraw="1" bufferColor="255,255,255,255" bufferBlendMode="0" bufferJoinStyle="128" bufferSize="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="RenderMetersInMapUnits" bufferNoFill="1"/>
            <text-mask maskOpacity="1" maskedSymbolLayers="" maskSizeUnits="MM" maskEnabled="0" maskJoinStyle="128" maskSize="1.5" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
            <background shapeRadiiY="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeJoinStyle="64" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOpacity="1" shapeRotation="0" shapeRadiiUnit="MM" shapeRotationType="0" shapeOffsetUnit="MM" shapeType="0" shapeSizeUnit="MM" shapeSVGFile="" shapeFillColor="255,255,255,255" shapeSizeY="0" shapeDraw="0" shapeSizeX="0" shapeBorderWidthUnit="MM" shapeOffsetX="0" shapeOffsetY="0" shapeRadiiX="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidth="0" shapeBorderColor="128,128,128,255">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{920c3cfc-becf-4610-965e-22d69f2be217}">
        <settings calloutType="simple">
          <text-style fontSizeUnit="RenderMetersInMapUnits" fieldName="IF(string_to_array(&quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[5] IS NULL, IF( &quot;statusBudynku&quot; = 1 AND (&quot;liczbaKondygnacjiNadziemnych&quot; > 0 OR (&quot;liczbaKondygnacjiNadziemnych&quot; IS NULL AND (&quot;liczbaKondygnacjiPodziemnych&quot; = 0 OR &quot;liczbaKondygnacjiPodziemnych&quot; IS NULL))), IF( @map_scale &lt;= 1000, concat( &quot;glownaFunkcjaBudynku&quot; , ' ',  &quot;liczbaKondygnacjiNadziemnych&quot;, ' ', regexp_replace( &quot;idBudynku&quot;, '(.*)\\.(.*)_BUD$', '\\2')), IF( @map_scale > 1000 AND  @map_scale &lt;= 2000, regexp_replace( &quot;idBudynku&quot;, '(.*)\\.(.*)_BUD$', ' \\2'), '')), IF(&quot;statusBudynku&quot; = 1 AND (&quot;liczbaKondygnacjiPodziemnych&quot; > 0 AND &quot;liczbaKondygnacjiNadziemnych&quot; = 0), IF( @map_scale &lt;= 1000, concat( &quot;glownaFunkcjaBudynku&quot; , ' -',  &quot;liczbaKondygnacjiPodziemnych&quot;, ' ', regexp_replace( &quot;idBudynku&quot;, '(.*)\\.(.*)_BUD$', '\\2') ), IF( @map_scale > 1000 AND  @map_scale &lt;= 2000, regexp_replace( &quot;idBudynku&quot;, '(.*)\\.(.*)_BUD$', ' \\2'), '')), '')), string_to_array(&quot;KR_ObiektKarto_etykieta_KREtykieta_tekst&quot; , ', ')[5])" textColor="10,9,9,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" legendString="Aa" isExpression="1" multilineHeight="1" fontUnderline="0" fontWeight="50" fontKerning="1" textOpacity="1" previewBkgrdColor="255,255,255,255" fontStrikeout="0" fontLetterSpacing="0" textOrientation="horizontal" fontWordSpacing="0" fontFamily="Arial" blendMode="0" namedStyle="Normal" allowHtml="0" capitalization="0" fontItalic="0" fontSize="1.25">
            <families/>
            <text-buffer bufferOpacity="1" bufferDraw="1" bufferColor="255,255,255,255" bufferBlendMode="0" bufferJoinStyle="128" bufferSize="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="RenderMetersInMapUnits" bufferNoFill="1"/>
            <text-mask maskOpacity="1" maskedSymbolLayers="" maskSizeUnits="MM" maskEnabled="0" maskJoinStyle="128" maskSize="1.5" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
            <background shapeRadiiY="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeJoinStyle="64" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOpacity="1" shapeRotation="0" shapeRadiiUnit="MM" shapeRotationType="0" shapeOffsetUnit="MM" shapeType="0" shapeSizeUnit="MM" shapeSVGFile="" shapeFillColor="255,255,255,255" shapeSizeY="0" shapeDraw="0" shapeSizeX="0" shapeBorderWidthUnit="MM" shapeOffsetX="0" shapeOffsetY="0" shapeRadiiX="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidth="0" shapeBorderColor="128,128,128,255">
