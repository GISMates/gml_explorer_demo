...
<qgis styleCategories="Symbology|Labeling|Actions" version="3.22.12-Białowieża" labelsEnabled="1">
  ...
  <labeling type="rule-based">
    <rules key="{1d73d11c-fc1b-44a6-9404-db0689841acc}">
      <rule scalemaxdenom="1001" description="Prezentacja graficzna" scalemindenom="1" filter=" IF(&quot;PrezentacjaGraficzna_geometria&quot;, &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True)" key="{8fb92fa0-edd4-430e-8e1f-9ef0ae34c1ba}">
        <settings calloutType="simple">
          <text-style fontItalic="0" capitalization="0" previewBkgrdColor="255,255,255,255" textColor="125,125,125,255" fontLetterSpacing="0" fontSizeUnit="RenderMetersInMapUnits" fontKerning="1" textOrientation="horizontal" textOpacity="1" legendString="Aa" fontFamily="Arial" fontUnderline="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontWeight="50" isExpression="1" blendMode="0" fontStrikeout="0" namedStyle="Normal" allowHtml="0" multilineHeight="1" useSubstitutions="0" fontWordSpacing="0" fieldName="regexp_replace( &quot;idPunktu&quot; , '(.*)\\.(.*)$', '\\2')" fontSize="0.75">
            <families/>
