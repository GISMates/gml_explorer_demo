...
<qgis labelsEnabled="1" styleCategories="Symbology|Labeling|Actions" version="3.22.12-Białowieża">
  <renderer-v2 enableorderby="0" type="RuleRenderer" forceraster="0" symbollevels="0" referencescale="-1">
    <rules key="{5a71896f-dbb8-4a5c-95c6-b2ed99ce03fa}">
      <rule key="{63f3a076-15f8-472c-9072-e09bd67ff6f5}" label="budynek naziemny EGBU" filter="&quot;liczbaKondygnacjiNadziemnych&quot; > 0 OR (&quot;liczbaKondygnacjiNadziemnych&quot; IS NULL AND (&quot;liczbaKondygnacjiPodziemnych&quot; = 0 OR &quot;liczbaKondygnacjiPodziemnych&quot; IS NULL))" symbol="0"/>
      <rule key="{7275aa22-c987-456d-b40b-fb1a7ee63ede}" label="budynek podziemny EGBU-p" filter="&quot;liczbaKondygnacjiPodziemnych&quot; IS NOT NULL AND (&quot;liczbaKondygnacjiNadziemnych&quot; = 0 OR &quot;liczbaKondygnacjiNadziemnych&quot; IS NULL)" symbol="1"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{e381e3e8-d2ac-417d-9bf9-afce82583bab}">
      <rule key="{3d7445bf-f48f-4f26-be4c-b19a6d578787}" description="Prezentacja graficzna" scalemindenom="1" filter="IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True), True), True)" scalemaxdenom="1001">
        <settings calloutType="simple">
          <text-style fontStrikeout="0" fontWeight="50" blendMode="0" textColor="85,170,255,255" fontFamily="Arial" fontKerning="1" textOrientation="horizontal" fontWordSpacing="0" fontUnderline="0" isExpression="1" fontItalic="0" capitalization="0" namedStyle="Normal" fontLetterSpacing="0" fontSize="1" legendString="Aa" useSubstitutions="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="RenderMetersInMapUnits" textOpacity="1" multilineHeight="1" previewBkgrdColor="255,255,255,255" allowHtml="0" fieldName="IF(string_to_array( &quot;PrezentacjaGraficzna_etykieta_Etykieta_justyfikacja&quot;  , ', ')[0] = '8',  &quot;EGB_AdresNieruchomosci_numerPorzadkowy&quot; , IF(&quot;liczbaKondygnacjiNadziemnych&quot; > 0 OR (&quot;liczbaKondygnacjiNadziemnych&quot; IS NULL AND (&quot;liczbaKondygnacjiPodziemnych&quot; = 0 OR &quot;liczbaKondygnacjiPodziemnych&quot; IS NULL)), concat(&quot;rodzajWgKST&quot;,  &quot;liczbaKondygnacjiNadziemnych&quot;), IF(&quot;liczbaKondygnacjiPodziemnych&quot; IS NOT NULL AND (&quot;liczbaKondygnacjiNadziemnych&quot; = 0 OR &quot;liczbaKondygnacjiNadziemnych&quot; IS NULL), concat(&quot;rodzajWgKST&quot;, IF(left(&quot;liczbaKondygnacjiPodziemnych&quot;, 1) = '-', '', '-'),  &quot;liczbaKondygnacjiPodziemnych&quot;), '')))">
            <families/>
      ...
      <rule key="{94ca0c76-920d-454b-8917-eee9be2f39c3}" description="Prezentacja graficzna" scalemindenom="1" filter="IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True), True), True)" scalemaxdenom="1001">
        <settings calloutType="simple">
          <text-style fontStrikeout="0" fontWeight="50" blendMode="0" textColor="85,170,255,255" fontFamily="Arial" fontKerning="1" textOrientation="horizontal" fontWordSpacing="0" fontUnderline="0" isExpression="1" fontItalic="0" capitalization="0" namedStyle="Normal" fontLetterSpacing="0" fontSize="1" legendString="Aa" useSubstitutions="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="RenderMetersInMapUnits" textOpacity="1" multilineHeight="1" previewBkgrdColor="255,255,255,255" allowHtml="0" fieldName="IF(string_to_array( &quot;PrezentacjaGraficzna_etykieta_Etykieta_justyfikacja&quot;  , ', ')[1] = '8',  &quot;EGB_AdresNieruchomosci_numerPorzadkowy&quot; , '')">
            <families/>
            <text-buffer bufferSize="0" bufferNoFill="1" bufferJoinStyle="128" bufferColor="255,255,255,255" bufferSizeUnits="RenderMetersInMapUnits" bufferOpacity="1" bufferDraw="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0"/>
            <text-mask maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskEnabled="0" maskSize="1.5" maskOpacity="1" maskType="0" maskJoinStyle="128" maskSizeUnits="MM" maskedSymbolLayers=""/>
            <background shapeJoinStyle="64" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeOffsetUnit="MM" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeOffsetX="0" shapeRadiiUnit="MM" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeSizeUnit="MM" shapeBorderColor="85,170,255,255" shapeSizeX="0" shapeOffsetY="0" shapeBorderWidth="0" shapeRotation="0" shapeRadiiX="0" shapeOpacity="1" shapeRotationType="0" shapeSVGFile="" shapeType="0" shapeFillColor="255,255,255,255" shapeRadiiY="0" shapeSizeType="0" shapeDraw="0" shapeBorderWidthUnit="MM" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0">
      ...
      <rule key="{25388f9c-46f2-49a6-9307-73db2ea19cce}" description="Prezentacja graficzna" scalemindenom="1" filter="IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True), True), True)" scalemaxdenom="1001">
        <settings calloutType="simple">
          <text-style fontStrikeout="0" fontWeight="50" blendMode="0" textColor="85,170,255,255" fontFamily="Arial" fontKerning="1" textOrientation="horizontal" fontWordSpacing="0" fontUnderline="0" isExpression="1" fontItalic="0" capitalization="0" namedStyle="Normal" fontLetterSpacing="0" fontSize="1" legendString="Aa" useSubstitutions="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="RenderMetersInMapUnits" textOpacity="1" multilineHeight="1" previewBkgrdColor="255,255,255,255" allowHtml="0" fieldName="IF(string_to_array( &quot;PrezentacjaGraficzna_etykieta_Etykieta_justyfikacja&quot;  , ', ')[2] = '8',  &quot;EGB_AdresNieruchomosci_numerPorzadkowy&quot; , '')">
            <families/>
            <text-buffer bufferSize="0" bufferNoFill="1" bufferJoinStyle="128" bufferColor="255,255,255,255" bufferSizeUnits="RenderMetersInMapUnits" bufferOpacity="1" bufferDraw="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0"/>
            <text-mask maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskEnabled="0" maskSize="1.5" maskOpacity="1" maskType="0" maskJoinStyle="128" maskSizeUnits="MM" maskedSymbolLayers=""/>
            <background shapeJoinStyle="64" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeOffsetUnit="MM" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeOffsetX="0" shapeRadiiUnit="MM" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeSizeUnit="MM" shapeBorderColor="85,170,255,255" shapeSizeX="0" shapeOffsetY="0" shapeBorderWidth="0" shapeRotation="0" shapeRadiiX="0" shapeOpacity="1" shapeRotationType="0" shapeSVGFile="" shapeType="0" shapeFillColor="255,255,255,255" shapeRadiiY="0" shapeSizeType="0" shapeDraw="0" shapeBorderWidthUnit="MM" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0">
      ...
      <rule key="{bb8fac58-ae3d-4407-8777-d10def888689}" description="Prezentacja graficzna" scalemindenom="1" filter="IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True), True), True)" scalemaxdenom="1001">
        <settings calloutType="simple">
          <text-style fontStrikeout="0" fontWeight="50" blendMode="0" textColor="85,170,255,255" fontFamily="Arial" fontKerning="1" textOrientation="horizontal" fontWordSpacing="0" fontUnderline="0" isExpression="1" fontItalic="0" capitalization="0" namedStyle="Normal" fontLetterSpacing="0" fontSize="1" legendString="Aa" useSubstitutions="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="RenderMetersInMapUnits" textOpacity="1" multilineHeight="1" previewBkgrdColor="255,255,255,255" allowHtml="0" fieldName="IF(string_to_array( &quot;PrezentacjaGraficzna_etykieta_Etykieta_justyfikacja&quot;  , ', ')[3] = '8',  &quot;EGB_AdresNieruchomosci_numerPorzadkowy&quot; , '')">
            <families/>
            <text-buffer bufferSize="0" bufferNoFill="1" bufferJoinStyle="128" bufferColor="255,255,255,255" bufferSizeUnits="RenderMetersInMapUnits" bufferOpacity="1" bufferDraw="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0"/>
            <text-mask maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskEnabled="0" maskSize="1.5" maskOpacity="1" maskType="0" maskJoinStyle="128" maskSizeUnits="MM" maskedSymbolLayers=""/>
            <background shapeJoinStyle="64" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeOffsetUnit="MM" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeOffsetX="0" shapeRadiiUnit="MM" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeSizeUnit="MM" shapeBorderColor="85,170,255,255" shapeSizeX="0" shapeOffsetY="0" shapeBorderWidth="0" shapeRotation="0" shapeRadiiX="0" shapeOpacity="1" shapeRotationType="0" shapeSVGFile="" shapeType="0" shapeFillColor="255,255,255,255" shapeRadiiY="0" shapeSizeType="0" shapeDraw="0" shapeBorderWidthUnit="MM" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0">
      ...
      <rule key="{bf53b28f-c0a0-439d-9b3d-c0c3a26d5e80}" description="Prezentacja graficzna" scalemindenom="1" filter="IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, IF(&quot;PrezentacjaGraficzna_geometria&quot;, &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL, True), True), True)" scalemaxdenom="1001">
        <settings calloutType="simple">
          <text-style fontStrikeout="0" fontWeight="50" blendMode="0" textColor="85,170,255,255" fontFamily="Arial" fontKerning="1" textOrientation="horizontal" fontWordSpacing="0" fontUnderline="0" isExpression="1" fontItalic="0" capitalization="0" namedStyle="Normal" fontLetterSpacing="0" fontSize="1" legendString="Aa" useSubstitutions="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="RenderMetersInMapUnits" textOpacity="1" multilineHeight="1" previewBkgrdColor="255,255,255,255" allowHtml="0" fieldName="IF(string_to_array( &quot;PrezentacjaGraficzna_etykieta_Etykieta_justyfikacja&quot;  , ', ')[4] = '8',  &quot;EGB_AdresNieruchomosci_numerPorzadkowy&quot; , '')">
            <families/>
            <text-buffer bufferSize="0" bufferNoFill="1" bufferJoinStyle="128" bufferColor="255,255,255,255" bufferSizeUnits="RenderMetersInMapUnits" bufferOpacity="1" bufferDraw="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0"/>
            <text-mask maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskEnabled="0" maskSize="1.5" maskOpacity="1" maskType="0" maskJoinStyle="128" maskSizeUnits="MM" maskedSymbolLayers=""/>
            <background shapeJoinStyle="64" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeOffsetUnit="MM" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeOffsetX="0" shapeRadiiUnit="MM" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeSizeUnit="MM" shapeBorderColor="85,170,255,255" shapeSizeX="0" shapeOffsetY="0" shapeBorderWidth="0" shapeRotation="0" shapeRadiiX="0" shapeOpacity="1" shapeRotationType="0" shapeSVGFile="" shapeType="0" shapeFillColor="255,255,255,255" shapeRadiiY="0" shapeSizeType="0" shapeDraw="0" shapeBorderWidthUnit="MM" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0">
