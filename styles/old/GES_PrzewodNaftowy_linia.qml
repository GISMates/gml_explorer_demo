...
<qgis version="3.22.4-Białowieża" styleCategories="Symbology|Labeling|Actions" labelsEnabled="1">
  <renderer-v2 referencescale="-1" enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{6189860c-f783-4145-a5f9-c7fbe370881b}">
      <rule symbol="0" filter="IF (@map_scale &lt;= 500, coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy' AND (&quot;srednica&quot; IS NULL OR &quot;srednica&quot;/1000 &lt;= 0.75), IF(@map_scale > 2000, coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy' AND (&quot;przebieg&quot; IS NULL OR &quot;przebieg&quot; IN('naziemny', 'nadziemny')), coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy'))" key="{17b0aab9-96d7-4a56-8020-c9ebc7055cad}" label="przewód naftowy SUPN_01"/>
      <rule scalemindenom="1" symbol="1" filter=" coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy' AND &quot;srednica&quot; IS NOT NULL AND &quot;srednica&quot;/1000 > 0.75" scalemaxdenom="501" key="{4ac38f4e-64a1-49d1-a0f2-91523b56b2e9}" label="przewód naftowy SUPN_02"/>
      <rule scalemindenom="1" symbol="2" filter="IF (@map_scale &lt;= 500, coalesce(&quot;istnienie&quot;, 'istniejacy') IN ('projektowany', 'wBudowie') AND (&quot;srednica&quot; IS NULL OR &quot;srednica&quot;/1000 &lt;= 0.75), coalesce(&quot;istnienie&quot;, 'istniejacy') IN ('projektowany', 'wBudowie'))" scalemaxdenom="1001" key="{9f838146-e704-4206-aed5-c16033ac42c5}" label="przewód naftowy - projektowany lub w budowie SUPN_P_01"/>
      <rule scalemindenom="1" symbol="3" filter=" coalesce(&quot;istnienie&quot;, 'istniejacy') IN ('projektowany', 'wBudowie') AND &quot;srednica&quot; IS NOT NULL AND &quot;srednica&quot;/1000 > 0.75" scalemaxdenom="501" key="{665618df-0093-4d15-89e0-f39559bc90ff}" label="przewód naftowy - projektowany lub w budowie SUPN_P_02"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{f8006db6-b226-4ecb-89f7-3e7ad443e1ca}">
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{ba568e59-88c0-4d1f-a8ec-6ea8df73509d}">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{2953fe47-bc96-4415-afec-0e98bf74f208}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{10667346-b8d5-4e3c-815a-757fa7cb0419}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{06473729-1f25-4ffd-b550-abf9e99fb602}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{b8043d1a-82a4-413c-a322-6a0f0eced7a1}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{a9ab55eb-0808-4ea0-a3ae-f4802c0fb703}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{b1d01aef-b4c5-4eb4-9f52-741ddf8f8bee}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{bc54ada1-153e-497b-92d5-4284fee11cfb}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{e5a73221-7cb1-403e-b7a9-9a2913fad9e8}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{6ce1f6b1-b996-453a-8b9d-ed76d97378de}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{dda82d6a-f991-4953-99cd-4955facfb6fb}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{af658aa4-8c6b-4198-8ce6-4dc793b98864}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{312b43c5-9add-47cf-874c-9bb642cecb5d}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{a60116da-9afd-4733-b2a0-37a6e21b985a}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{7cf8e0c8-b07a-4ed6-bf7d-553e364dd581}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{fcf6416f-a705-4f78-b749-2375fc4f4958}">
        <settings calloutType="simple">
