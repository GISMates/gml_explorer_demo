...
<qgis version="3.22.4-Białowieża" styleCategories="Symbology|Labeling|Actions" labelsEnabled="1">
  <renderer-v2 referencescale="-1" enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{71b7bbce-494c-4b4c-a9ad-89f3ba342d8d}">
      <rule symbol="0" filter="IF (@map_scale &lt;= 500, coalesce(&quot;srednica&quot;, 1)/1000 &lt;= 0.75 AND (coalesce( &quot;wymiarPionowy&quot;, 1)/1000 &lt;= 0.75 AND coalesce( &quot;wymiarPoziomy&quot;, 1)/1000 &lt;= 0.75) AND coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy', IF(@map_scale > 500 AND @map_scale &lt;= 1000, coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy' ,(&quot;przebieg&quot; IS NULL OR &quot;przebieg&quot; IN('naziemny', 'nadziemny')) AND coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy'))" key="{9f7b1189-8c11-44ee-9db0-349f420427df}" label="przewód kanalizacyjny SUPK_01"/>
      <rule scalemindenom="1" symbol="1" filter="(coalesce( &quot;srednica&quot;, 0)/1000 > 0.75 OR coalesce( &quot;wymiarPionowy&quot;, 0)/1000 > 0.75 OR coalesce( &quot;wymiarPoziomy&quot;, 0)/1000 > 0.75) AND coalesce(&quot;istnienie&quot;, 'istniejacy') = 'istniejacy'" scalemaxdenom="501" key="{0e7c69d6-bc91-4223-b536-7e6df8c00450}" label="przewód kanalizacyjny SUPK_02"/>
      <rule symbol="2" filter="IF (@map_scale &lt;= 500, coalesce(&quot;srednica&quot;, 1)/1000 &lt;= 0.75 AND (coalesce( &quot;wymiarPionowy&quot;, 1)/1000 &lt;= 0.75 AND coalesce( &quot;wymiarPoziomy&quot;, 1)/1000 &lt;= 0.75) AND coalesce(&quot;istnienie&quot;, 'istniejacy') IN('projektowany', 'wBudowie'), coalesce(&quot;istnienie&quot;, 'istniejacy') IN('projektowany', 'wBudowie'))" key="{bbfd7fa6-0f19-4978-ae93-94bed844daa0}" label="przewód kanalizacyjny - projektowany lub w budowie SUPK_P_01"/>
      <rule scalemindenom="1" symbol="3" filter="(coalesce( &quot;srednica&quot;, 0)/1000 > 0.75 OR coalesce( &quot;wymiarPionowy&quot;, 0)/1000 > 0.75 OR coalesce( &quot;wymiarPoziomy&quot;, 0)/1000 > 0.75) AND coalesce(&quot;istnienie&quot;, 'istniejacy') IN('projektowany', 'wBudowie')" scalemaxdenom="501" key="{84ea7db1-c41c-4c05-8f2d-cab0a61bfc32}" label="przewód kanalizacyjny - projektowany lub w budowie SUPK_P_02"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{7416f22a-bb24-4dcf-b249-683fe140d078}">
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{fc92b452-6375-4d13-a750-0d52cb8707dd}">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{5cc61e38-9989-4811-9064-4bcfaf29d259}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{fd396fad-62a3-4f23-91fc-9c12466df82c}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{001b8b04-8818-46f3-adc3-bec1e3788ef6}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{a55b5ad9-0457-4bd0-ae98-b9dd9de8e041}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{8d8acc59-a39e-4978-83b5-9b66e4a589c0}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{349e64ca-b9af-4aa9-8600-def206d24f9a}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{ac265430-1638-48cd-84d6-ecf0a37c9f1a}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{f560d88f-27ec-48a0-a66d-f53c12ec0842}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{210020bf-9691-4d8b-a928-a99ca3dcb56d}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{e08efd0b-e2fb-4206-9c29-ddda8c89a1be}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{bbbf6245-7df8-4578-875c-503a1c5988c4}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{dfeea4d5-555f-4e9b-a22f-ba937ac966b6}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{ca8967a1-4494-415b-b88a-f294adaebad6}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{c60e261d-051a-4884-8ea2-796ef929f6b7}">
        <settings calloutType="simple">
      ...
      <rule scalemindenom="1" description="KR_Etykieta" filter="&quot;KR_ObiektKarto_geometriaKarto&quot; IS NOT NULL" scalemaxdenom="5001" key="{2a6849da-5de6-4a42-a88c-0698757a5135}">
        <settings calloutType="simple">
